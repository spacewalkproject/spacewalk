...
- fixed an unhandled exception when doing a history lookup (aron@redhat.com)
- cleaned up system_upgradepackage and system_listupgrades (aron@redhat.com)
- added calls to generate_package_cache in get_package_name and get_package_id
  (aron@redhat.com)
- use macros for commands where possible (aron@redhat.com)
- use existing file details (owner, group, mode) when updating a config file
  (aron@redhat.com)
- cleanup the bash completion file (aron@redhat.com)
- Automatic commit of package [spacecmd] release [0.4.2-1]. (aron@redhat.com)
