...
%changelog
* Wed Feb 10 2010 Justin Sherrill <jsherril@redhat.com> 0.9.1-1
- more tomcat6 fixes (jsherril@redhat.com)
- more tomcat6 stuff (jsherril@redhat.com)
- more tomcat6 changes (jsherril@redhat.com)
- tomcat6 specfile changes (jsherril@redhat.com)
