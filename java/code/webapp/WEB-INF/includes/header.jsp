...
<p id="geo"><c:out value="${rhnActiveLang} "/> (<a href="/rhn/account/LocalePreferences.do"><bean:message key="header.jsp.change"/></a>)</p>
	...
	<div id="utilityAccount">
        <p>
         <span class="label"><bean:message key="header.jsp.loggedin"/></span> <a href="/rhn/account/UserDetails.do"><c:out escapeXml="true" value="${requestScope.session.user.login}" /></a><span class="navPipe">|</span><a href="/rhn/account/UserPreferences.do"><bean:message key="header.jsp.preferences"/></a><span class="navPipe">|</span><html:link forward="logout"><span><bean:message key="header.jsp.signout"/></span></html:link>
...
<div id="header">
      <rhn:require acl="is(satellite)">
          <img src="/img/logo.png" alt="<bean:message key="layout.jsp.productname"/>" width="228" height="52" id="rhnLogo" /></a>
      </rhn:require>
      <rhn:require acl="user_authenticated()">
 <div id="searchbar">
    <div id="searchbarinner">
      ...
      <%--  NotReadyForSpacewalk 0.2, will go into 0.4  
