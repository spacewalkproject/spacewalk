...
<rhn:toolbar base="h1" img="/img/rhn-icon-software.gif" imgAlt="channels.overview.toolbar.imgAlt">
  <bean:message key="channels.relevant.jsp.toolbar"/>
</rhn:toolbar>

<%@ include file="/WEB-INF/pages/common/fragments/channel/channel_tabs.jspf" %>

<p>
<bean:message key="channels.relevant.jsp.header1" />
</p>

<p>
	<bean:message key="channels.relevant.jsp.header2" />
</p>


<form method="post" name="rhn_list" action="/rhn/software/channels/Relevant.do">
