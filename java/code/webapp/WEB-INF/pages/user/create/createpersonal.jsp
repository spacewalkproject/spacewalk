...
<h2><bean:message key="usercreate.createPersonal" /></h2>

    <div class="page-summary">
      <p><bean:message key="usercreate.personalSummary" /></p>
...
<jsp:include page="usercreate.jsp">
  <jsp:param name="action_path" value="/newlogin/CreateUserSubmit"/>
</jsp:include>
