...
<html:html xhtml="true">
  <body>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.general"/></h4>
      </div>
      <div class="panel-body">
    ...
    <c:if test="${!(empty dmi_vendor and empty dmi_bios and empty dmi_system and empty dmi_product and empty dmi_asset_tag and empty dmi_board)}">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4><bean:message key="sdc.details.hardware.dmi"/></h4>
        </div>
        <div class="panel-body">
          <table class="table table-condensed">
            <tr>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.networking"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <tr>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.storage"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.video"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed" >
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.audio"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.usb"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.capture"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4><bean:message key="sdc.details.hardware.misc"/></h4>
      </div>
      <div class="panel-body">
        <table class="table table-condensed">
          <thead>
