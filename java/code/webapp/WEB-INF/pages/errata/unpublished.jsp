...
<form method="post" name="rhn_list" action="/rhn/errata/manage/UnpublishedErrataSubmit.do">
	<rhn:list pageList="${requestScope.pageList}" noDataText="erratalist.jsp.nounpublishederrata"
	          legend="errata">
