...
import com.redhat.rhn.frontend.action.channel.RelevantChannelTreeAction;
...
/**
 * RelevantChannelTreeSetupActionTest
 * @version $Rev$
 */
public class RelevantChannelTreeActionTest extends RhnBaseTestCase {
    
    public void testPerformExecute() throws Exception {
        RelevantChannelTreeAction action = new RelevantChannelTreeAction() {
            protected DataResult getDataResult(User user, ListControl lc) {
                return ChannelManager.relevantChannelTree(user, lc);
            }
        };
