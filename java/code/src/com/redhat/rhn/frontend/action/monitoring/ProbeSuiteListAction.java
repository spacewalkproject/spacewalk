 ...
 * @version $Rev: 51639 $
 */
public class ProbeSuiteListAction extends RhnSetAction {
    ...
    public ActionForward forwardToConfirm(ActionMapping mapping,
        ...
        return getStrutsDelegate().forwardParams(mapping.findForward(forwardName), params);
    }
    ...
    protected void processMethodKeys(Map map) {
        map.put("probesuites.jsp.deleteprobesuites", "forwardToConfirm");        
    }
