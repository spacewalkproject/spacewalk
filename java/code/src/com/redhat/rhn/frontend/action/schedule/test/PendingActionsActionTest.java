...
import com.redhat.rhn.frontend.action.schedule.PendingActionsAction;
import com.redhat.rhn.frontend.action.schedule.ScheduledActionAction;

/**
 * PendingActionsActionTest
 * @version $Rev$
 */
public class PendingActionsActionTest extends ScheduledActionActionTestCase {

    protected ScheduledActionAction getAction() {
        return new PendingActionsAction();
    }
