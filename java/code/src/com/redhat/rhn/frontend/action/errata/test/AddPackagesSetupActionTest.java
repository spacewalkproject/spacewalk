...
import com.redhat.rhn.frontend.action.errata.AddPackagesSetupAction;
 ...
 * @version $Rev$
 */
public class AddPackagesSetupActionTest extends RhnBaseTestCase {

    public void testExecute() throws Exception {
        AddPackagesSetupAction action = new AddPackagesSetupAction();
        ...
        //make sure we got something for viewoptions
        assertNotNull(sah.getRequest().getAttribute("viewoptions"));
