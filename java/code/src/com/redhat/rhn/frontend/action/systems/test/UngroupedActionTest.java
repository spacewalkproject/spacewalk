...
import com.redhat.rhn.frontend.action.systems.UngroupedAction;

/**
 * UngroupedActionTest
 * @version $Rev$
 */
public class UngroupedActionTest extends BaseSystemListActionTestCase {

    protected BaseSystemListAction createAction() {
        return new UngroupedAction();
    }
