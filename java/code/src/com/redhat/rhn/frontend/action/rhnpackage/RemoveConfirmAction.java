 ...
 * @version $Rev$
 */
public class RemoveConfirmAction extends RhnSetAction {
    ...
    public ActionForward runRemoteCommand(ActionMapping mapping,
        ...
        params.put("mode", PACKAGE_REMOVE);
     ...
     * @return The ActionForward to go to next.
     */
    public ActionForward removePackages(ActionMapping mapping,
                                       ActionForm formIn,
                                       HttpServletRequest request,
                                       HttpServletResponse response) {
        ...
        PackageAction pa = ActionManager.schedulePackageRemoval(user, server, pkgSet);
        ...
        if (numPackages == 1) {
            msgs.add(ActionMessages.GLOBAL_MESSAGE,
                     new ActionMessage("message.packageremoval",
            ...
            msgs.add(ActionMessages.GLOBAL_MESSAGE,
                     new ActionMessage("message.packageremovals", 
                             LocalizationService.getInstance()
                             .formatNumber(new Integer(numPackages)),
                         pa.getId().toString(),
                         sid.toString(),
    ...
    protected void processMethodKeys(Map map) {
        map.put("removeconfirm.jsp.confirm", "removePackages");
        map.put("removeconfirm.jsp.runremotecommand", "runRemoteCommand");
    }
