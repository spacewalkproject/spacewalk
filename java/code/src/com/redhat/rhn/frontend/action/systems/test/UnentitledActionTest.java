...
import com.redhat.rhn.frontend.action.systems.UnentitledAction;

/**
 * UnentitledActionTest
 * @version $Rev$
 */
public class UnentitledActionTest extends BaseSystemListActionTestCase {

    /**
     * {@inheritDoc}
     */
    protected BaseSystemListAction createAction() {
        return new UnentitledAction();
    }
