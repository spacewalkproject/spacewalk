...
import com.redhat.rhn.frontend.action.systems.ProxyListAction;

/**
 * ProxyListActionTest
 * @version $Rev$
 */
public class ProxyListActionTest extends BaseSystemListActionTestCase {

    protected BaseSystemListAction createAction() {
        return new ProxyListAction();
    }
