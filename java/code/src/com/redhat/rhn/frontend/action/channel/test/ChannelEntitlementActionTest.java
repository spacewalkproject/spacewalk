...
import com.redhat.rhn.frontend.action.channel.ChannelEntitlementAction;
 ...
 * @version $Rev$
 */
public class ChannelEntitlementActionTest extends RhnBaseTestCase {
    public ChannelEntitlementActionTest(String name) {
        super(name);
    }
