 ...
 * @version $Rev$
 */
public class InstallPackageAction extends RhnSetAction {
    /**
     * Removes Packages
     ...
     */
    public ActionForward confirmPackageInstall(ActionMapping mapping,
                                       ActionForm formIn,
        ...
        // can't call makeParamMap from here.  It puts in
        // a lower= param which messes up the confirm page.
        // we only need the sid.
    ...
    protected DataResult getDataResult(User user, 
        ...
        Server server = ServerFactory.lookupById(
                requestContext.getRequiredParam("sid"));
        if (!server.isSolaris()) {
    ...
    protected void processMethodKeys(Map map) {
        map.put("installpkgs.jsp.installpackages", "confirmPackageInstall");
    }
