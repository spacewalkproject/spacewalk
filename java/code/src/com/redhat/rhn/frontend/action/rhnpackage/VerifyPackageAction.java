 ...
 * @version $Rev$
 */
public class VerifyPackageAction extends RhnSetAction {
     ...
     */
    public ActionForward confirmPackageVerify(ActionMapping mapping,
                                       ActionForm formIn,
        ...
        // don't want to have lower= param added to url.
    ...
    protected DataResult getDataResult(User user, 
        ...
        return PackageManager.systemPackageList(sid, null);
    }
    ...
    protected void processMethodKeys(Map map) {
        map.put("verifypkgs.jsp.verifypackages", "confirmPackageVerify");
    }
