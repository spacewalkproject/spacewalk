...
import com.redhat.rhn.frontend.action.systems.InactiveAction;

public class InactiveActionTest extends BaseSystemListActionTestCase {

    protected BaseSystemListAction createAction() {
        return new InactiveAction();
    }
