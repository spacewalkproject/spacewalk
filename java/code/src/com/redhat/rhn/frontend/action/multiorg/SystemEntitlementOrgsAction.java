...
public class SystemEntitlementOrgsAction extends RhnAction {
    ...
    private static Logger log = Logger.getLogger(SystemEntitlementOrgsAction.class);
    /**
     * ${@inheritDoc}
     */
    public ActionForward execute(ActionMapping mapping, ActionForm form, 
        ...
        DataList <Map> result = OrgManager.allOrgsSingleEntitlement(entitlementLabel);
    ...
    private ActionErrors updateSubscriptions(Org org, DynaActionForm dynaForm, 
        HttpServletRequest request, Entitlement ent, String newCount) {        
