...
import com.redhat.rhn.frontend.action.systems.OutOfDateAction;

/**
 * OutOfDateActionTest
 * @version $Rev$
 */
public class OutOfDateActionTest extends BaseSystemListActionTestCase {

    /**
     * {@inheritDoc}
     */
    protected BaseSystemListAction createAction() {
        return new OutOfDateAction();
    }
