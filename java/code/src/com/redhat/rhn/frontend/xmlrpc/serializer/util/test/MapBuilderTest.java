...
public class MapBuilderTest extends RhnBaseTestCase {
     ...
     * This means alls methods are included except for the ones returning null. 
    ...
    public void testBaseCase() throws Exception {
        ...
        //Check the size -> excludes the null value
        assertEquals(properties.size() - 1, map.size()); 
        assertMethod(map, "fieldWierdo", TestBean.DEFAULT_VALUE, true);
        assertMethod(map, "fieldNull", "", false);
    }
