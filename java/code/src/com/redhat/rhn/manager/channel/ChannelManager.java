...
public class ChannelManager extends BaseManager {
    ...
    /**
     * Indicates the the supplied channel actions should be committed. This call assumes
     * the actions are valid. In other words, the list of channels to (un)subscribe should
     * have been previously been validated by called to
     * {@link #linkChannelsToSubscribeForServers(User, List, List)} and
     * {@link #linkChannelsToUnsubscribeForServers(List, List)} 
     * 
     * @param user    user performing the action creations
     * @param actions actions (both subscribe and unsubscribe) to commit to the database
     */
    public static void performChannelActions(User user, List<ChannelActionDAO> actions) {
