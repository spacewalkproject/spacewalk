...
//    
//    /** Static entitlement, mainly used to check on provisioning entitlements. */
...
//                                    lookupEntitlementByLabel("rhn_provisioning");
    ...
    */ 
    ...
    /**
     * Get the set of EntitlementServerGroups that 
     * this Org is a member of.
     * 
    ...
    /**
     * Get the set of ManagedServerGroups that 
     * this Org is a member of.
     * 
     * @return List of ServerGroup classes
     */
    ...
    /**
     * TODO: get rid of Role label and pass in the class
     * Reset channel permissions for a user/channel/role combination
    ...
    /**
     * TODO: get rid of Role label and pass in the class    
     * Remove all channel permissions for a user/channel/role combination
     * @param uid User ID to reset
     * @param cid Channel ID 
     * @param roleLabel label of Role to reset 
     */
     ...
     * @return true if the Org is a paying customer, or false if it's a demo account.
     */
    ...
    */
    ...
    /**
     * Gets the list of active org admins
     * (com.redhat.rhn.domain.user.User objects) in this org.
     * @return Returns the set of active org admins in this org.
     */
    List getActiveOrgAdmins();
    /**
     * Gets the com.redhat.rhn.domain.monitoring.satcluster.SatClusters associated
     * with this Org.  Null if there are none or is not a Monitoring Sat.
