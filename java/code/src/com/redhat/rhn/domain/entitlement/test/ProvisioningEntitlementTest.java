 ...
 * @version $Rev$
 */
public class ProvisioningEntitlementTest extends BaseEntitlementTestCase {

    protected void createEntitlement() {
        ent = new ProvisioningEntitlement();
    }

    protected String getLabel() {
        return EntitlementManager.PROVISIONING_ENTITLED;
    }
}
