...
deleteQueries = ["deleteLastErrata", "deleteLastPackage", "deleteLastServer", "deleteLastHardwareDevice"]
...
dirs = [indexWorkDir+"/package", indexWorkDir+"/errata", indexWorkDir+"/server", indexWorkDir+"/hwdevice"]
dirs.each { 
    cmd = "rm -r $it"
