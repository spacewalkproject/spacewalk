...
deleteQueries = ["deleteLastErrata", "deleteLastPackage", "deleteLastServer", "deleteLastHardwareDevice", "deleteLastSnapshotTag"]
...
dirs = [indexWorkDir+"/package", indexWorkDir+"/errata", indexWorkDir+"/server", indexWorkDir+"/hwdevice", indexWorkDir+"/snapshotTag"]
dirs.each { 
    cmd = "rm -r $it"
