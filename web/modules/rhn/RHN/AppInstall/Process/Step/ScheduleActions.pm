...
package RHN::AppInstall::Process::Step::ScheduleActions;
...
sub push_action {
  ...
  foreach my $action (@actions) {
    throw "(set_error) $action is not an RHN::AppInstall::Process::Step::ScheduleActions::Action"
      unless (ref $action and $action->isa('RHN::AppInstall::Process::Step::ScheduleActions::Action'));
  }
