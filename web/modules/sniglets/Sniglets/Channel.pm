...
EOM
  ...
  $pxt->push_message(site_info => 'Note:  RHN Proxy and ' . PXT::Config->get("web.product_name") . ' systems may not be changed from their base channel.') if $sats_or_proxies_in_set;
