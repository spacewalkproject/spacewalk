...
(
    recid               numeric   (12) not null constraint rhn_cqins_recid_pk primary key
--            using index tablespace [[4m_tbs]]
    ...
    constraint rhn_cqins_cqcmd_command_id_fk foreign key ( command_id ) references rhn_command_queue_commands( recid )
)
--    enable row movement
  ;
