...
begin
    ...
    select web_user_personal_id_seq.nextval into personal_info_id from dual;

    insert into web_contact
        (id, org_id, oracle_contact_id, personal_info_id)
    values
        (user_id, org_id_in, oracle_contact_id_in, personal_info_id);
    ...
    insert into web_user_personal_info 
        (id, prefix, first_names, last_name, genqual,
	parent_company, company, title, phone, fax, email, pin,
	first_names_ol, last_name_ol, login, login_uc, password, old_password)
    values
        (personal_info_id, prefix_in, first_names_in, last_name_in, genqual_in, 
	parent_company_in, company_in, title_in, phone_in, fax_in, email_in, pin_in,
	first_names_ol_in, last_name_ol_in, login_in, upper(login_in), password_in, null);
