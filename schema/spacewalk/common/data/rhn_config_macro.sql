...
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'ALL', 'NPBIN', '/usr/bin', 'Production user bin directory', '0', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'ALL', 'NPETC', '/etc/nocpulse', 'Production user etc directory', '0', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'ALL', 'NPHOME', '/var/lib/%{USER}', 'Production user home directory', '0', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'ALL', 'NPVAR', '/var/log/%{USER}', 'Production user var directory', '0', 'system',sysdate);
