-- Generated by Ora2Pg, the Oracle database Schema converter, version 4.11
-- Copyright 2000-2008 Gilles DAROLD. All rights reserved.
--
...
CREATE TABLE "rhnchanneltrust" (
	...
	"org_trust_id" float NOT NULL,
	"created" timestamp DEFAULT (CURRENT_TIMESTAMP)
                        ,
	"modified" timestamp DEFAULT (CURRENT_TIMESTAMP)
                        
);
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_modified_nn" CHECK ("modified" is not null);
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_cid_nn" CHECK ("channel_id" is not null);
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_otid_nn" CHECK ("org_trust_id" is not null);
CREATE UNIQUE INDEX rhn_channel_trust_cid_uq ON "rhnchanneltrust" ("channel_id","org_trust_id");
CREATE INDEX rhn_channel_trust_org_trust ON "rhnchanneltrust" ("org_trust_id");
...
CREATE TABLE "rhnsystemmigrations" (
	"org_id_to" float NOT NULL,
	"org_id_from" float NOT NULL,
	"server_id" float NOT NULL
);
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_oidto_nn" CHECK ("org_id_to" is not null);
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_sid_nn" CHECK ("server_id" is not null);
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_oidfrm_nn" CHECK ("org_id_from" is not null);
CREATE INDEX rsm_org_id_to_idx ON "rhnsystemmigrations" ("org_id_to");
CREATE INDEX rsm_org_id_from_idx ON "rhnsystemmigrations" ("org_id_from");
...
ALTER TABLE "rhnpackageprovider" ADD PRIMARY KEY ("id");
ALTER TABLE "rhnpackageprovider" ADD CONSTRAINT "rhn_pkg_provider_id_nn" CHECK ("id" is not null);
ALTER TABLE "rhnpackageprovider" ADD CONSTRAINT "rhn_pkg_provider_key_nn" CHECK ("name" is not null);
ALTER TABLE "rhnpackageprovider" ADD CONSTRAINT "rhn_pkg_provider_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnpackageprovider" ADD CONSTRAINT "rhn_pkg_provider_modified_nn" CHECK ("modified" is not null);
CREATE INDEX rhn_pkg_provider_id_n_idx ON "rhnpackageprovider" ("id","name");
...
CREATE INDEX rhn_channel_access_idx ON "rhnchannel" ("channel_access");
...
ALTER TABLE "rhnpackagekey" ADD PRIMARY KEY ("id");
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_keyid_uq" UNIQUE ("key_id");
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_key_nn" CHECK ("key_id" is not null);
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_type_id_nn" CHECK ("key_type_id" is not null);
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_id_nn" CHECK ("id" is not null);
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_modified_nn" CHECK ("modified" is not null);
CREATE INDEX rhn_pkey_id_k_pid_idx ON "rhnpackagekey" ("id","key_id","provider_id","key_type_id");
...
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_channelflg_nn" CHECK ("channel_flag" is not null);
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_modified_nn" CHECK ("modified" is not null);
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_oid_nn" CHECK ("org_id" is not null);
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_channelflg_ck" CHECK (channel_flag in ('N','Y'));
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_migrflg_ck" CHECK (migration_flag in ('N','Y'));
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_migrflg_nn" CHECK ("migration_flag" is not null);
...
ALTER TABLE "rhnset" ADD CONSTRAINT "rhn_set_user_label_elem_unq" UNIQUE ("user_id","label","element","element_two","element_three");
...
ALTER TABLE "rhnpackagechangelog" ADD PRIMARY KEY ("id");
...
ALTER TABLE "rhnpackagechangelog" ADD CONSTRAINT "rhn_pkg_cl_id_nn" CHECK ("id" is not null);
...
ALTER TABLE "rhnpackagekeytype" ADD PRIMARY KEY ("id");
ALTER TABLE "rhnpackagekeytype" ADD CONSTRAINT "rhn_pkg_key_type_modified_nn" CHECK ("modified" is not null);
ALTER TABLE "rhnpackagekeytype" ADD CONSTRAINT "rhn_pkg_key_type_label_nn" CHECK ("label" is not null);
ALTER TABLE "rhnpackagekeytype" ADD CONSTRAINT "rhn_pkg_key_type_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnpackagekeytype" ADD CONSTRAINT "rhn_pkg_key_type_id_nn" CHECK ("id" is not null);
CREATE INDEX rhn_pkg_key_type_id_n_idx ON "rhnpackagekeytype" ("id","label");
...
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_kid_nn" CHECK ("key_id" is not null);
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_pid_nn" CHECK ("package_id" is not null);
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_modified_nn" CHECK ("modified" is not null);
CREATE UNIQUE INDEX rhn_pkeya_pk_uq ON "rhnpackagekeyassociation" ("package_id","key_id");
...
CREATE TABLE "rhnksrawdata" (
	"kickstart_id" float NOT NULL,
	"data" bytea
);
ALTER TABLE "rhnksrawdata" ADD CONSTRAINT "rhn_ks_raw_data_tid_nn" CHECK ("kickstart_id" is not null);
...
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_modified_nn" CHECK ("modified" is not null);
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_created_nn" CHECK ("created" is not null);
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_oid_nn" CHECK ("org_id" is not null);
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_otid_nn" CHECK ("org_trust_id" is not null);
CREATE UNIQUE INDEX rhn_trusted_orgs_oid_uq ON "rhntrustedorgs" ("org_id","org_trust_id");
...
CREATE UNIQUE INDEX rhn_sactionvr_sanec_uq ON "rhnserveractionverifyresult" ("server_id","action_id","package_name_id","package_evr_id","package_arch_id","package_capability_id");
...
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_verbose_up2date_ck" CHECK (verboseup2date in ('Y','N'));
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_cfg_save_nn" CHECK ("kscfg" is not null);
...
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_pre_log_ck" CHECK (preLog in ('Y','N'));
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_pre_log_nn" CHECK ("prelog" is not null);
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_label_nn" CHECK ("label" is not null);
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_nonchroot_post_nn" CHECK ("nonchrootpost" is not null);
...
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_nonchroot_post_ck" CHECK (nonchrootpost in ('Y','N'));
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_cfg_save_ck" CHECK (kscfg in ('Y','N'));
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_verbose_up2date_nn" CHECK ("verboseup2date" is not null);
...
CREATE UNIQUE INDEX rhn_sactionvm_sanec_uq ON "rhnserveractionverifymissing" ("server_id","action_id","package_name_id","package_evr_id","package_arch_id","package_capability_id");
...
CREATE UNIQUE INDEX rhn_package_md5_oid_uq ON "rhnpackage" ("md5sum","org_id");
...
CREATE TABLE "rhn_command" (
	...
	"allowed_in_suite" char(1) DEFAULT '1'
        ,
	"command_class" varchar(255) DEFAULT '/opt/home/nocpulse/libexec/plugin'
        ,
...
ALTER TABLE "rhnregtokenpackages" ADD PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX rhn_reg_tok_pkg_uq ON "rhnregtokenpackages" ("id","token_id","name_id","arch_id");
...
ALTER TABLE "rhn_url_probe" ADD CONSTRAINT "rhn_urlpb_probe_pr_id_pr_fk" FOREIGN KEY ("probe_id","probe_type") REFERENCES "rhn_probe" ("recid","probe_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchanneltrust" ADD CONSTRAINT "rhn_channel_trust_otid_fk" FOREIGN KEY ("org_trust_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigdatefile" ADD CONSTRAINT "rhn_actioncd_file_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_interface_monitoring" ADD CONSTRAINT "rhn_monif_server_name_fk" FOREIGN KEY ("server_id","server_name") REFERENCES "rhnservernetinterface" ("server_id","name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfaq" ADD CONSTRAINT "rhn_faq_class_fk" FOREIGN KEY ("class_id") REFERENCES "rhnfaqclass" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelcomps" ADD CONSTRAINT "rhn_channelcomps_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofilepackage" ADD CONSTRAINT "rhn_sprofile_spid_fk" FOREIGN KEY ("server_profile_id") REFERENCES "rhnserverprofile" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofilepackage" ADD CONSTRAINT "rhn_sprofile_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofilepackage" ADD CONSTRAINT "rhn_sprofile_evrid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofilepackage" ADD CONSTRAINT "rhn_sprofile_package_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncryptokey" ADD CONSTRAINT "rhn_cryptokey_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncryptokey" ADD CONSTRAINT "rhn_cryptokey_cktid_fk" FOREIGN KEY ("crypto_key_type_id") REFERENCES "rhncryptokeytype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_schedule_days" ADD CONSTRAINT "rhn_schdy_sched_schedule_id_fk" FOREIGN KEY ("schedule_id") REFERENCES "rhn_schedules" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesensemap" ADD CONSTRAINT "rhn_pkg_sensemap_sid_fk" FOREIGN KEY ("sense_id") REFERENCES "rhnpackagesense" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserinfopane" ADD CONSTRAINT "rhn_usr_info_pane_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserinfopane" ADD CONSTRAINT "rhn_usr_info_pane_pid_fk" FOREIGN KEY ("pane_id") REFERENCES "rhninfopane" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverchannel" ADD CONSTRAINT "rhn_sc_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverchannel" ADD CONSTRAINT "rhn_sc_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_oidto_fk" FOREIGN KEY ("org_id_to") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_oidfrm_fk" FOREIGN KEY ("org_id_from") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsystemmigrations" ADD CONSTRAINT "rhn_sys_mig_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverarch" ADD CONSTRAINT "rhn_sarch_atid_fk" FOREIGN KEY ("arch_type_id") REFERENCES "rhnarchtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageconflicts" ADD CONSTRAINT "rhn_pkg_conflicts_package_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageconflicts" ADD CONSTRAINT "rhn_pkg_conflicts_cap_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtshutdown" ADD CONSTRAINT "rhn_avshutdown_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannel" ADD CONSTRAINT "rhn_channel_parent_ch_fk" FOREIGN KEY ("parent_channel") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannel" ADD CONSTRAINT "rhn_channel_org_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannel" ADD CONSTRAINT "rhn_channel_caid_fk" FOREIGN KEY ("channel_arch_id") REFERENCES "rhnchannelarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannel" ADD CONSTRAINT "rhn_channel_product_name_ch_fk" FOREIGN KEY ("product_name_id") REFERENCES "rhnproductname" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannel" ADD CONSTRAINT "rhn_channel_cpid_fk" FOREIGN KEY ("channel_product_id") REFERENCES "rhnchannelproduct" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntaskqueue" ADD CONSTRAINT "rhn_task_queue_org_id_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratacve" ADD CONSTRAINT "rhn_err_cve_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratacve" ADD CONSTRAINT "rhn_err_cve_cid_fk" FOREIGN KEY ("cve_id") REFERENCES "rhncve" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_config_parameter" ADD CONSTRAINT "rhn_confp_grpnm_group_name_fk" FOREIGN KEY ("group_name") REFERENCES "rhn_config_group" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_config_parameter" ADD CONSTRAINT "rhn_confp_scrty_sec_type_fk" FOREIGN KEY ("security_type") REFERENCES "rhn_config_security_type" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokengroups" ADD CONSTRAINT "rhn_reg_tok_grp_id_fk" FOREIGN KEY ("token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokengroups" ADD CONSTRAINT "rhn_reg_tok_grp_sgs_fk" FOREIGN KEY ("server_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_type_id_prid_fk" FOREIGN KEY ("key_type_id") REFERENCES "rhnpackagekeytype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagekey" ADD CONSTRAINT "rhn_pkey_prid_fk" FOREIGN KEY ("provider_id") REFERENCES "rhnpackageprovider" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatch" ADD CONSTRAINT "rhn_solaris_p_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatch" ADD CONSTRAINT "rhn_solaris_p_pt_fk" FOREIGN KEY ("patch_type") REFERENCES "rhnsolarispatchtype" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstarttimezone" ADD CONSTRAINT "rhn_ks_timezone_it_fk" FOREIGN KEY ("install_type") REFERENCES "rhnksinstalltype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratatmp" ADD CONSTRAINT "rhn_erratatmp_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_url_probe_step" ADD CONSTRAINT "rhn_urlps_urlpb_url_pr_id_fk" FOREIGN KEY ("url_probe_id") REFERENCES "rhn_url_probe" ("probe_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceeventlog" ADD CONSTRAINT "rhn_viel_vii_fk" FOREIGN KEY ("virtual_instance_id") REFERENCES "rhnvirtualinstance" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceeventlog" ADD CONSTRAINT "rhn_viel_et_fk" FOREIGN KEY ("event_type") REFERENCES "rhnvirtualinstanceeventtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceeventlog" ADD CONSTRAINT "rhn_viel_old_state_fk" FOREIGN KEY ("old_state") REFERENCES "rhnvirtualinstancestate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceeventlog" ADD CONSTRAINT "rhn_viel_new_state_fk" FOREIGN KEY ("new_state") REFERENCES "rhnvirtualinstancestate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_queue_instances" ADD CONSTRAINT "rhn_cqins_cqcmd_command_id_fk" FOREIGN KEY ("command_id") REFERENCES "rhn_command_queue_commands" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_probe" ADD CONSTRAINT "rhn_probe_cmmnd_command_id_fk" FOREIGN KEY ("command_id") REFERENCES "rhn_command" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_probe" ADD CONSTRAINT "rhn_probe_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_probe" ADD CONSTRAINT "rhn_probe_prbtp_probe_type_fk" FOREIGN KEY ("probe_type") REFERENCES "rhn_probe_types" ("probe_type") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntag" ADD CONSTRAINT "rhn_tag_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhntagname" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntag" ADD CONSTRAINT "rhn_tag_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverhistory" ADD CONSTRAINT "rhn_serverhistory_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstance" ADD CONSTRAINT "rhn_vi_hsi_fk" FOREIGN KEY ("host_system_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstance" ADD CONSTRAINT "rhn_vi_vsi_fk" FOREIGN KEY ("virtual_system_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_probe_param_value" ADD CONSTRAINT "rhn_ppval_chkpb_probe_id_fk" FOREIGN KEY ("probe_id") REFERENCES "rhn_probe" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_probe_param_value" ADD CONSTRAINT "rhn_ppval_cmd_id_parm_nm_fk" FOREIGN KEY ("command_id","param_name") REFERENCES "rhn_command_parameter" ("command_id","param_name") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilechanneltmp" ADD CONSTRAINT "rhn_efilectmp_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilechanneltmp" ADD CONSTRAINT "rhn_efilectmp_eid_fk" FOREIGN KEY ("errata_file_id") REFERENCES "rhnerratafiletmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpackagearchcompat" ADD CONSTRAINT "rhn_cp_ac_caid_fk" FOREIGN KEY ("channel_arch_id") REFERENCES "rhnchannelarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpackagearchcompat" ADD CONSTRAINT "rhn_cp_ac_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnallowtrust" ADD CONSTRAINT "rhn_allow_trust_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnram" ADD CONSTRAINT "rhn_ram_server_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorginfo" ADD CONSTRAINT "rhn_orginfo_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorginfo" ADD CONSTRAINT "rhn_orginfo_dgt_fk" FOREIGN KEY ("default_group_type") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartscript" ADD CONSTRAINT "rhn_ksscript_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_node_probe" ADD CONSTRAINT "rhn_sndpb_pr_recid_pr_typ_fk" FOREIGN KEY ("probe_id","probe_type") REFERENCES "rhn_probe" ("recid","probe_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_node_probe" ADD CONSTRAINT "rhn_sndpb_satnd_sat_nd_id_fk" FOREIGN KEY ("sat_node_id") REFERENCES "rhn_sat_node" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntemplatestring" ADD CONSTRAINT "rhn_template_str_cid_fk" FOREIGN KEY ("category_id") REFERENCES "rhntemplatecategory" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtreboot" ADD CONSTRAINT "rhn_avreboot_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_snmp_alert" ADD CONSTRAINT "rhn_snmp_alert_sat_cluster_fk" FOREIGN KEY ("sender_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergrouptypefeature" ADD CONSTRAINT "rhn_sgt_sgid_fk" FOREIGN KEY ("server_group_type_id") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergrouptypefeature" ADD CONSTRAINT "rhn_sgt_fid_fk" FOREIGN KEY ("feature_id") REFERENCES "rhnfeature" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncustomdatakey" ADD CONSTRAINT "rhn_cdatakey_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncustomdatakey" ADD CONSTRAINT "rhn_cdatakey_cb_fk" FOREIGN KEY ("created_by") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncustomdatakey" ADD CONSTRAINT "rhn_cdatakey_lmb_fk" FOREIGN KEY ("last_modified_by") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_service_probe_origins" ADD CONSTRAINT "rhn_srvpo_chkpb_orig_pr_id_fk" FOREIGN KEY ("origin_probe_id") REFERENCES "rhn_check_suite_probe" ("probe_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_service_probe_origins" ADD CONSTRAINT "rhn_srvpo_pr_serv_pr_fk" FOREIGN KEY ("service_probe_id") REFERENCES "rhn_probe" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratakeywordtmp" ADD CONSTRAINT "rhn_err_keywordtmp_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerratatmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverinfo" ADD CONSTRAINT "rhn_server_info_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpath" ADD CONSTRAINT "rhn_serverpath_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpath" ADD CONSTRAINT "rhn_serverpath_psid_fk" FOREIGN KEY ("proxy_server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelparent" ADD CONSTRAINT "rhn_cp_ch_fk" FOREIGN KEY ("channel") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelparent" ADD CONSTRAINT "rhn_cp_parent_ch_fk" FOREIGN KEY ("parent_channel") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerrataclonedtmp" ADD CONSTRAINT "rhn_eclonedtmp_feid_fk" FOREIGN KEY ("original_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerrataclonedtmp" ADD CONSTRAINT "rhn_eclonedtmp_teid_fk" FOREIGN KEY ("id") REFERENCES "rhnerratatmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnset" ADD CONSTRAINT "rhn_set_user_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionkickstart" ADD CONSTRAINT "rhn_actionks_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_kstid_fk" FOREIGN KEY ("kstree_id") REFERENCES "rhnkickstartabletree" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_sched_fk" FOREIGN KEY ("scheduler") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_osid_fk" FOREIGN KEY ("old_server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_nsid_fk" FOREIGN KEY ("new_server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_hsid_fk" FOREIGN KEY ("host_server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_ksssid_fk" FOREIGN KEY ("state_id") REFERENCES "rhnkickstartsessionstate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_ks_session_spid_fk" FOREIGN KEY ("server_profile_id") REFERENCES "rhnserverprofile" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsession" ADD CONSTRAINT "rhn_kss_kvt_fk" FOREIGN KEY ("virtualization_type") REFERENCES "rhnkickstartvirtualizationtype" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageorder" ADD CONSTRAINT "rhn_act_pkg_apid_fk" FOREIGN KEY ("action_package_id") REFERENCES "rhnactionpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusergroup" ADD CONSTRAINT "rhn_usergroup_type_fk" FOREIGN KEY ("group_type") REFERENCES "rhnusergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusergroup" ADD CONSTRAINT "rhn_user_group_org_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkstreefile" ADD CONSTRAINT "rhn_kstreefile_kid_fk" FOREIGN KEY ("kstree_id") REFERENCES "rhnkickstartabletree" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgerratacachequeue" ADD CONSTRAINT "rhn_oecq_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratabuglisttmp" ADD CONSTRAINT "rhn_errata_buglisttmp_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerratatmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratakeyword" ADD CONSTRAINT "rhn_err_keyword_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhngrailcomponents" ADD CONSTRAINT "rhn_grail_comp_role_type_fk" FOREIGN KEY ("role_required") REFERENCES "rhnusergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveraction" ADD CONSTRAINT "rhn_server_action_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveraction" ADD CONSTRAINT "rhn_server_action_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveraction" ADD CONSTRAINT "rhn_server_action_status_fk" FOREIGN KEY ("status") REFERENCES "rhnactionstatus" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_group_members" ADD CONSTRAINT "rhn_cntgm_cgid_fk" FOREIGN KEY ("contact_group_id") REFERENCES "rhn_contact_groups" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_group_members" ADD CONSTRAINT "rhn_cntgm_mcmid_fk" FOREIGN KEY ("member_contact_method_id") REFERENCES "rhn_contact_methods" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_group_members" ADD CONSTRAINT "rhn_cntgm_mcgid_fk" FOREIGN KEY ("member_contact_group_id") REFERENCES "rhn_contact_groups" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverchannelarchcompat" ADD CONSTRAINT "rhn_sc_ac_said_fk" FOREIGN KEY ("server_arch_id") REFERENCES "rhnserverarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverchannelarchcompat" ADD CONSTRAINT "rhn_sc_ac_caid_fk" FOREIGN KEY ("channel_arch_id") REFERENCES "rhnchannelarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_node" ADD CONSTRAINT "rhn_satnd_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_node" ADD CONSTRAINT "rhn_satnd_cmdtg_rid_tar_ty_fk" FOREIGN KEY ("recid","target_type") REFERENCES "rhn_command_target" ("recid","target_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_node" ADD CONSTRAINT "rhn_satnd_satcl_sat_cl_id_fk" FOREIGN KEY ("sat_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_capid_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageremovalfailure" ADD CONSTRAINT "rhn_apr_failure_suggested_fk" FOREIGN KEY ("suggested") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigfile" ADD CONSTRAINT "rhn_conffile_ccid_fk" FOREIGN KEY ("config_channel_id") REFERENCES "rhnconfigchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigfile" ADD CONSTRAINT "rhn_conffile_cfnid_fk" FOREIGN KEY ("config_file_name_id") REFERENCES "rhnconfigfilename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigfile" ADD CONSTRAINT "rhn_conffile_sid_fk" FOREIGN KEY ("state_id") REFERENCES "rhnconfigfilestate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigfile" ADD CONSTRAINT "rhn_conffile_lcrid_fk" FOREIGN KEY ("latest_config_revision_id") REFERENCES "rhnconfigrevision" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartcommand" ADD CONSTRAINT "rhn_kscommand_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartcommand" ADD CONSTRAINT "rhn_kscommand_kcnid_fk" FOREIGN KEY ("ks_command_name_id") REFERENCES "rhnkickstartcommandname" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilylicenseconsent" ADD CONSTRAINT "rhn_cfl_consent_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilylicenseconsent" ADD CONSTRAINT "rhn_cfl_consent_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilylicenseconsent" ADD CONSTRAINT "rhn_cfl_consent_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagechangelog" ADD CONSTRAINT "rhn_pkg_changelog_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverdmi" ADD CONSTRAINT "rhn_server_dmi_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserinfo" ADD CONSTRAINT "rhn_user_info_user_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserinfo" ADD CONSTRAINT "rhn_user_info_tzid_fk" FOREIGN KEY ("timezone_id") REFERENCES "rhntimezone" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesource" ADD CONSTRAINT "rhn_pkgsrc_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesource" ADD CONSTRAINT "rhn_pkgsrc_srid_fk" FOREIGN KEY ("source_rpm_id") REFERENCES "rhnsourcerpm" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesource" ADD CONSTRAINT "rhn_pkgsrc_group_fk" FOREIGN KEY ("package_group") REFERENCES "rhnpackagegroup" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhngrailcomponentchoices" ADD CONSTRAINT "rhn_grail_comp_ch_user_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpreservefilelist" ADD CONSTRAINT "rhn_serverpfl_ksid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpreservefilelist" ADD CONSTRAINT "rhn_serverpfl_flid_fk" FOREIGN KEY ("file_list_id") REFERENCES "rhnfilelist" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionpackageresult" ADD CONSTRAINT "rhn_sap_result_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionpackageresult" ADD CONSTRAINT "rhn_sap_result_apid_fk" FOREIGN KEY ("action_package_id") REFERENCES "rhnactionpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntextmessage" ADD CONSTRAINT "rhn_tm_message_id_fk" FOREIGN KEY ("message_id") REFERENCES "rhnmessage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafiletmp" ADD CONSTRAINT "rhn_erratafiletmp_errata_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerratatmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafiletmp" ADD CONSTRAINT "rhn_erratafiletmp_type_fk" FOREIGN KEY ("type") REFERENCES "rhnerratafiletype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_schedules" ADD CONSTRAINT "rhn_sched_cstmr_cust_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_schedules" ADD CONSTRAINT "rhn_sched_schtp_sched_ty_fk" FOREIGN KEY ("schedule_type_id") REFERENCES "rhn_schedule_types" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserdefaultsystemgroups" ADD CONSTRAINT "rhn_udsg_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserdefaultsystemgroups" ADD CONSTRAINT "rhn_udsg_cidffk" FOREIGN KEY ("system_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnperrataqueue" ADD CONSTRAINT "rhn_snperrqueue_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotchannel" ADD CONSTRAINT "rhn_snapchan_sid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotchannel" ADD CONSTRAINT "rhn_snapchan_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaultregtoken" ADD CONSTRAINT "rhn_ksdrt_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaultregtoken" ADD CONSTRAINT "rhn_ksdrt_rtid_fk" FOREIGN KEY ("regtoken_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtresume" ADD CONSTRAINT "rhn_avresume_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverevent" ADD CONSTRAINT "rhn_se_server_id_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_user_contact_permission" ADD CONSTRAINT "contperm_wbuserid_fk" FOREIGN KEY ("web_user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverinstallinfo" ADD CONSTRAINT "rhn_server_install_info_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_target" ADD CONSTRAINT "rhn_cmdtg_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackagedelta" ADD CONSTRAINT "rhn_act_pd_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackagedelta" ADD CONSTRAINT "rhn_act_pd_pdid_fk" FOREIGN KEY ("package_delta_id") REFERENCES "rhnpackagedelta" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncpu" ADD CONSTRAINT "rhn_cpu_server_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncpu" ADD CONSTRAINT "rhn_cpu_caid_fk" FOREIGN KEY ("cpu_arch_id") REFERENCES "rhncpuarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndistchannelmap" ADD CONSTRAINT "rhn_dcm_caid_fk" FOREIGN KEY ("channel_arch_id") REFERENCES "rhnchannelarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndistchannelmap" ADD CONSTRAINT "rhn_dcm_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_check_suites" ADD CONSTRAINT "rhn_cksut_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneedederratacache" ADD CONSTRAINT "rhn_snec_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneedederratacache" ADD CONSTRAINT "rhn_snec_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneedederratacache" ADD CONSTRAINT "rhn_snec_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_param_threshold" ADD CONSTRAINT "rhn_coptr_cmd_id_cmd_cl_fk" FOREIGN KEY ("command_id","command_class") REFERENCES "rhn_command" ("recid","command_class") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_param_threshold" ADD CONSTRAINT "rhn_coptr_m_thr_m_cmd_cl_fk" FOREIGN KEY ("command_class","threshold_metric_id") REFERENCES "rhn_metrics" ("command_class","metric_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_param_threshold" ADD CONSTRAINT "rhn_coptr_thrtp_thres_type_fk" FOREIGN KEY ("threshold_type_name") REFERENCES "rhn_threshold_type" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratapackage" ADD CONSTRAINT "rhn_err_pkg_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratapackage" ADD CONSTRAINT "rhn_err_pkg_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndownloads" ADD CONSTRAINT "rhn_dl_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndownloads" ADD CONSTRAINT "rhn_dl_fid_fk" FOREIGN KEY ("file_id") REFERENCES "rhnfile" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndownloads" ADD CONSTRAINT "rhn_dl_dltype_fk" FOREIGN KEY ("download_type") REFERENCES "rhndownloadtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_check_probe" ADD CONSTRAINT "rhn_chkpb_host_id_fk" FOREIGN KEY ("host_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_check_probe" ADD CONSTRAINT "rhn_chkpb_recid_probe_typ_fk" FOREIGN KEY ("probe_id","probe_type") REFERENCES "rhn_probe" ("recid","probe_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_check_probe" ADD CONSTRAINT "rhn_chkpb_satcl_sat_cl_id_fk" FOREIGN KEY ("sat_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionscriptresult" ADD CONSTRAINT "rhn_serveras_result_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionscriptresult" ADD CONSTRAINT "rhn_serveras_result_asid_fk" FOREIGN KEY ("action_script_id") REFERENCES "rhnactionscript" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageobsoletes" ADD CONSTRAINT "rhn_pkg_obsoletes_package_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageobsoletes" ADD CONSTRAINT "rhn_pkg_obsoletes_cap_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchanneldownloads" ADD CONSTRAINT "rhn_cd_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchanneldownloads" ADD CONSTRAINT "rhn_cd_did_fk" FOREIGN KEY ("downloads_id") REFERENCES "rhndownloads" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerrataqueue" ADD CONSTRAINT "rhn_equeue_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigdate" ADD CONSTRAINT "rhn_actioncd_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgentitlements" ADD CONSTRAINT "rhn_org_ent_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgentitlements" ADD CONSTRAINT "rhn_org_ent_eid_fk" FOREIGN KEY ("entitlement_id") REFERENCES "rhnorgentitlementtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionpackage" ADD CONSTRAINT "rhn_transpack_op_fk" FOREIGN KEY ("operation") REFERENCES "rhntransactionoperation" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionpackage" ADD CONSTRAINT "rhn_transpack_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionpackage" ADD CONSTRAINT "rhn_transpack_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionpackage" ADD CONSTRAINT "rhn_transpack_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesyncblacklist" ADD CONSTRAINT "rhn_packagesyncbl_pnid_fk" FOREIGN KEY ("package_name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagesyncblacklist" ADD CONSTRAINT "rhn_packagesyncbl_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagekeyassociation" ADD CONSTRAINT "rhn_pkeya_kid_fk" FOREIGN KEY ("key_id") REFERENCES "rhnpackagekey" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverservergrouparchcompat" ADD CONSTRAINT "rhn_ssg_ac_said_fk" FOREIGN KEY ("server_arch_id") REFERENCES "rhnserverarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverservergrouparchcompat" ADD CONSTRAINT "rhn_ssg_ac_sgt_fk" FOREIGN KEY ("server_group_type") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservertokenregs" ADD CONSTRAINT "rhn_srv_reg_tok_tid_fk" FOREIGN KEY ("token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservertokenregs" ADD CONSTRAINT "rhn_srv_reg_tok_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnksrawdata" ADD CONSTRAINT "rhn_ks_raw_data_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactiondaemonconfig" ADD CONSTRAINT "rhn_actiondc_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneededpackagecache" ADD CONSTRAINT "rhn_sncp_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneededpackagecache" ADD CONSTRAINT "rhn_sncp_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneededpackagecache" ADD CONSTRAINT "rhn_sncp_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverneededpackagecache" ADD CONSTRAINT "rhn_sncp_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncryptokeykickstart" ADD CONSTRAINT "rhn_ckey_ks_ckid_fk" FOREIGN KEY ("crypto_key_id") REFERENCES "rhncryptokey" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhncryptokeykickstart" ADD CONSTRAINT "rhn_ckey_ks_ksd_fk" FOREIGN KEY ("ksdata_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndailysummaryqueue" ADD CONSTRAINT "rhn_dsqueue_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_os_commands_xref" ADD CONSTRAINT "rhn_oscxr_cmmnd_commands_id_fk" FOREIGN KEY ("commands_id") REFERENCES "rhn_command" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_os_commands_xref" ADD CONSTRAINT "rhn_oscxr_os000_os_id_fk" FOREIGN KEY ("os_id") REFERENCES "rhn_os" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelcloned" ADD CONSTRAINT "rhn_channelclone_fcid_fk" FOREIGN KEY ("original_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelcloned" ADD CONSTRAINT "rhn_channelclone_tcid_fk" FOREIGN KEY ("id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfilelistmembers" ADD CONSTRAINT "rhn_flmembers_flid_fk" FOREIGN KEY ("file_list_id") REFERENCES "rhnfilelist" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfilelistmembers" ADD CONSTRAINT "rhn_flmembers_cfnid_fk" FOREIGN KEY ("config_file_name_id") REFERENCES "rhnconfigfilename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvisibleobjects" ADD CONSTRAINT "rhn_vis_objs_sess_fk" FOREIGN KEY ("pxt_session_id") REFERENCES "pxtsessions" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactivationkey" ADD CONSTRAINT "rhn_act_key_reg_tid_fk" FOREIGN KEY ("reg_token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactivationkey" ADD CONSTRAINT "rhn_act_key_ks_sid_fk" FOREIGN KEY ("ks_session_id") REFERENCES "rhnkickstartsession" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatelliteinfo" ADD CONSTRAINT "rhn_satellite_info_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatelliteinfo" ADD CONSTRAINT "rhn_satellite_info_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotconfigrevision" ADD CONSTRAINT "rhn_snapshotcr_sid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotconfigrevision" ADD CONSTRAINT "rhn_snapshotcr_crid_fk" FOREIGN KEY ("config_revision_id") REFERENCES "rhnconfigrevision" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_units" ADD CONSTRAINT "rhn_units_qnta0_quantum_id_fk" FOREIGN KEY ("quantum_id") REFERENCES "rhn_quanta" ("quantum_id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactiontransactions" ADD CONSTRAINT "rhn_at_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactiontransactions" ADD CONSTRAINT "rhn_at_ftid_fk" FOREIGN KEY ("from_trans_id") REFERENCES "rhntransaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactiontransactions" ADD CONSTRAINT "rhn_at_ttid_fk" FOREIGN KEY ("to_trans_id") REFERENCES "rhntransaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfile" ADD CONSTRAINT "rhn_file_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_method_targets" ADD CONSTRAINT "rhn_rdrmt_cmeth_redirect_id_fk" FOREIGN KEY ("contact_method_id") REFERENCES "rhn_contact_methods" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_method_targets" ADD CONSTRAINT "rhn_rdrmt_rdrct_redirect_id_fk" FOREIGN KEY ("redirect_id") REFERENCES "rhn_redirects" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceinstalllog" ADD CONSTRAINT "rhn_viil_ks_sid_fk" FOREIGN KEY ("ks_session_id") REFERENCES "rhnkickstartsession" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverlocation" ADD CONSTRAINT "rhn_serverlocation_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_db_environment" ADD CONSTRAINT "rhn_dbenv_envir_environment_fk" FOREIGN KEY ("environment") REFERENCES "rhn_environment" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartchildchannel" ADD CONSTRAINT "rhn_ks_cc_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartchildchannel" ADD CONSTRAINT "rhn_ks_cc_ksd_fk" FOREIGN KEY ("ksdata_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusermessage" ADD CONSTRAINT "rhn_um_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusermessage" ADD CONSTRAINT "rhn_um_message_id_fk" FOREIGN KEY ("message_id") REFERENCES "rhnmessage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusermessage" ADD CONSTRAINT "rhn_um_status_fk" FOREIGN KEY ("status") REFERENCES "rhnusermessagestatus" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionscript" ADD CONSTRAINT "rhn_actscript_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackage" ADD CONSTRAINT "rhn_efilep_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackage" ADD CONSTRAINT "rhn_efilep_fileid_fk" FOREIGN KEY ("errata_file_id") REFERENCES "rhnerratafile" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpackage" ADD CONSTRAINT "rhn_cp_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpackage" ADD CONSTRAINT "rhn_cp_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservernotes" ADD CONSTRAINT "rhn_servernotes_creator_fk" FOREIGN KEY ("creator") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservernotes" ADD CONSTRAINT "rhn_servernotes_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatellitechannelfamily" ADD CONSTRAINT "rhn_sat_cf_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatellitechannelfamily" ADD CONSTRAINT "rhn_sat_cf_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchedpackage" ADD CONSTRAINT "rhn_solaris_patchedp_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchedpackage" ADD CONSTRAINT "rhn_solaris_patchedp_pid_fk" FOREIGN KEY ("patch_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchedpackage" ADD CONSTRAINT "rhn_solaris_patchedp_pnid_fk" FOREIGN KEY ("package_nevra_id") REFERENCES "rhnpackagenevra" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnproxyinfo" ADD CONSTRAINT "rhn_proxy_info_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnproxyinfo" ADD CONSTRAINT "rhn_proxy_info_peid_fk" FOREIGN KEY ("proxy_evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroupnotes" ADD CONSTRAINT "rhn_servergrp_note_creator_fk" FOREIGN KEY ("creator") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroupnotes" ADD CONSTRAINT "rhn_servergrp_note_fk" FOREIGN KEY ("server_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotservergroup" ADD CONSTRAINT "rhn_snapshotsg_sid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotservergroup" ADD CONSTRAINT "rhn_snapshotsg_sgid_fk" FOREIGN KEY ("server_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackageanswerfile" ADD CONSTRAINT "rhn_act_p_af_apid_fk" FOREIGN KEY ("action_package_id") REFERENCES "rhnactionpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpublicchannelfamily" ADD CONSTRAINT "rhn_pubcf_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotpackage" ADD CONSTRAINT "rhn_snapshotpkg_sid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotpackage" ADD CONSTRAINT "rhn_snapshotpkg_nid_fk" FOREIGN KEY ("nevra_id") REFERENCES "rhnpackagenevra" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_server_monitoring_info" ADD CONSTRAINT "rhn_host_server_id_fk" FOREIGN KEY ("recid") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_server_monitoring_info" ADD CONSTRAINT "rhn_host_server_name_fk" FOREIGN KEY ("os_id") REFERENCES "rhn_os" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilyvirtsublevel" ADD CONSTRAINT "rhn_cfvsl_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilyvirtsublevel" ADD CONSTRAINT "rhn_cfvsl_vslid_fk" FOREIGN KEY ("virt_sub_level_id") REFERENCES "rhnvirtsublevel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenconfigchannels" ADD CONSTRAINT "rhn_regtok_confchan_tid_fk" FOREIGN KEY ("token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenconfigchannels" ADD CONSTRAINT "rhn_regtok_confchan_ccid_fk" FOREIGN KEY ("config_channel_id") REFERENCES "rhnconfigchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtrefresh" ADD CONSTRAINT "rhn_avrefresh_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnappinstallsessiondata" ADD CONSTRAINT "rhn_appinst_sdata_sid_fk" FOREIGN KEY ("session_id") REFERENCES "rhnappinstallsession" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_queue_sessions" ADD CONSTRAINT "rhn_cqses_cntct_contact_idfk" FOREIGN KEY ("contact_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntrustedorgs" ADD CONSTRAINT "rhn_trusted_orgs_otid_fk" FOREIGN KEY ("org_trust_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnprivatechannelfamily" ADD CONSTRAINT "rhn_privcf_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnprivatechannelfamily" ADD CONSTRAINT "rhn_privcf_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenorgdefault" ADD CONSTRAINT "rhn_reg_token_def_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenorgdefault" ADD CONSTRAINT "rhn_reg_token_def_tokid_fk" FOREIGN KEY ("reg_token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackage" ADD CONSTRAINT "rhn_act_p_act_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackage" ADD CONSTRAINT "rhn_act_p_name_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackage" ADD CONSTRAINT "rhn_act_p_evr_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionpackage" ADD CONSTRAINT "rhn_act_p_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchsetmembers" ADD CONSTRAINT "rhn_solaris_psm_pid_fk" FOREIGN KEY ("patch_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchsetmembers" ADD CONSTRAINT "rhn_solaris_psm_psid_fk" FOREIGN KEY ("patch_set_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservercacheinfo" ADD CONSTRAINT "rhn_server_cache_info_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserserverprefs" ADD CONSTRAINT "rhn_userserverprefs_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserserverprefs" ADD CONSTRAINT "rhn_userserverprefs_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigchannel" ADD CONSTRAINT "rhn_confchan_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigchannel" ADD CONSTRAINT "rhn_confchan_ctid_fk" FOREIGN KEY ("confchan_type_id") REFERENCES "rhnconfigchanneltype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_criteria" ADD CONSTRAINT "rhn_rdrcr_rdrct_redirect_id_fk" FOREIGN KEY ("redirect_id") REFERENCES "rhn_redirects" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_criteria" ADD CONSTRAINT "rhn_rdrcr_rdrmt_match_nm_fk" FOREIGN KEY ("match_param") REFERENCES "rhn_redirect_match_types" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilechannel" ADD CONSTRAINT "rhn_efilec_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilechannel" ADD CONSTRAINT "rhn_efilec_eid_fk" FOREIGN KEY ("errata_file_id") REFERENCES "rhnerratafile" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfilelocation" ADD CONSTRAINT "rhn_fileloc_fid_fk" FOREIGN KEY ("file_id") REFERENCES "rhnfile" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservercustomdatavalue" ADD CONSTRAINT "rhn_scdv_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservercustomdatavalue" ADD CONSTRAINT "rhn_scdv_kid_fk" FOREIGN KEY ("key_id") REFERENCES "rhncustomdatakey" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservercustomdatavalue" ADD CONSTRAINT "rhn_scdv_cb_fk" FOREIGN KEY ("created_by") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservercustomdatavalue" ADD CONSTRAINT "rhn_scdv_lmb_fk" FOREIGN KEY ("last_modified_by") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_metrics" ADD CONSTRAINT "rhn_metrc_comcl_cmd_class_fk" FOREIGN KEY ("command_class") REFERENCES "rhn_command_class" ("class_name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_metrics" ADD CONSTRAINT "rhn_metrc_uts_stor_ut_id_fk" FOREIGN KEY ("storage_unit_id") REFERENCES "rhn_units" ("unit_id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartpreservefilelist" ADD CONSTRAINT "rhn_kspreservefl_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartpreservefilelist" ADD CONSTRAINT "rhn_kspreservefl_flid_fk" FOREIGN KEY ("file_list_id") REFERENCES "rhnfilelist" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchpackages" ADD CONSTRAINT "rhn_solaris_pp_fk" FOREIGN KEY ("patch_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchpackages" ADD CONSTRAINT "rhn_solaris_pnid_fk" FOREIGN KEY ("package_nevra_id") REFERENCES "rhnpackagenevra" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtoken" ADD CONSTRAINT "rhn_reg_token_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtoken" ADD CONSTRAINT "rhn_reg_token_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtoken" ADD CONSTRAINT "rhn_reg_token_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_user_personal_info" ADD CONSTRAINT "personal_info_web_user_id_fk" FOREIGN KEY ("web_user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_user_personal_info" ADD CONSTRAINT "wupi_prefix_fk" FOREIGN KEY ("prefix") REFERENCES "web_user_prefix" ("text") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserver" ADD CONSTRAINT "rhn_server_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserver" ADD CONSTRAINT "rhn_server_said_fk" FOREIGN KEY ("server_arch_id") REFERENCES "rhnserverarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserver" ADD CONSTRAINT "rhn_server_creator_fk" FOREIGN KEY ("creator_id") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserver" ADD CONSTRAINT "rhn_server_psid_fk" FOREIGN KEY ("provision_state_id") REFERENCES "rhnprovisionstate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverconfigchannel" ADD CONSTRAINT "rhn_servercc_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverconfigchannel" ADD CONSTRAINT "rhn_servercc_ccid_fk" FOREIGN KEY ("config_channel_id") REFERENCES "rhnconfigchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotconfigchannel" ADD CONSTRAINT "rhn_snapshotcc_sid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshotconfigchannel" ADD CONSTRAINT "rhn_snapshotcc_ccid_fk" FOREIGN KEY ("config_channel_id") REFERENCES "rhnconfigchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnclientcapability" ADD CONSTRAINT "rhn_clientcap_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnclientcapability" ADD CONSTRAINT "rhn_clientcap_cap_nid_fk" FOREIGN KEY ("capability_name_id") REFERENCES "rhnclientcapabilityname" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshottag" ADD CONSTRAINT "rhn_st_ssid_fk" FOREIGN KEY ("snapshot_id") REFERENCES "rhnsnapshot" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshottag" ADD CONSTRAINT "rhn_st_tid_fk" FOREIGN KEY ("tag_id") REFERENCES "rhntag" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshottag" ADD CONSTRAINT "rhn_st_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsgtypevirtsublevel" ADD CONSTRAINT "rhn_sgtvsl_sgtid_fk" FOREIGN KEY ("server_group_type_id") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsgtypevirtsublevel" ADD CONSTRAINT "rhn_sgtvsl_vslid_fk" FOREIGN KEY ("virt_sub_level_id") REFERENCES "rhnvirtsublevel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfilelist" ADD CONSTRAINT "rhn_filelist_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratapackagetmp" ADD CONSTRAINT "rhn_err_pkgtmp_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerratatmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratapackagetmp" ADD CONSTRAINT "rhn_err_pkgtmp_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilylicense" ADD CONSTRAINT "rhn_cfl_cfid_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshot" ADD CONSTRAINT "rhn_snapshot_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshot" ADD CONSTRAINT "rhn_snapshot_invalid_fk" FOREIGN KEY ("invalid") REFERENCES "rhnsnapshotinvalidreason" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnapshot" ADD CONSTRAINT "rhn_snapshot_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnversioninfo" ADD CONSTRAINT "rhn_versioninfo_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnversioninfo" ADD CONSTRAINT "rhn_versioninfo_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnemailaddresslog" ADD CONSTRAINT "rhn_eaddresslog_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnaction" ADD CONSTRAINT "rhn_action_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnaction" ADD CONSTRAINT "rhn_action_at_fk" FOREIGN KEY ("action_type") REFERENCES "rhnactiontype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnaction" ADD CONSTRAINT "rhn_action_scheduler_fk" FOREIGN KEY ("scheduler") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnaction" ADD CONSTRAINT "rhn_action_prereq_fk" FOREIGN KEY ("prerequisite") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_pnid_fk" FOREIGN KEY ("package_name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_peid_fk" FOREIGN KEY ("package_evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifyresult" ADD CONSTRAINT "rhn_sactionvr_pcid_fk" FOREIGN KEY ("package_capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "valid_countries_tl" ADD CONSTRAINT "valid_countries_tl_code" FOREIGN KEY ("code") REFERENCES "valid_countries" ("code") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnwebcontactchangelog" ADD CONSTRAINT "rhn_wcon_cl_wcon_id_fk" FOREIGN KEY ("web_contact_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnwebcontactchangelog" ADD CONSTRAINT "rhn_wcon_cl_wcon_from_id_fk" FOREIGN KEY ("web_contact_from_id") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnwebcontactchangelog" ADD CONSTRAINT "rhn_wcon_cl_csid_fk" FOREIGN KEY ("change_state_id") REFERENCES "rhnwebcontactchangestate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnksdata" ADD CONSTRAINT "rhn_ks_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusergroupmembers" ADD CONSTRAINT "rhn_ugmembers_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnusergroupmembers" ADD CONSTRAINT "rhn_ugmembers_ugid_fk" FOREIGN KEY ("user_group_id") REFERENCES "rhnusergroup" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsgtypebaseaddoncompat" ADD CONSTRAINT "rhn_sgt_bac_bid_fk" FOREIGN KEY ("base_id") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsgtypebaseaddoncompat" ADD CONSTRAINT "rhn_sgt_bac_aid_fk" FOREIGN KEY ("addon_id") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenentitlement" ADD CONSTRAINT "rhn_reg_tok_ent_rtid_fk" FOREIGN KEY ("reg_token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenentitlement" ADD CONSTRAINT "rhn_reg_tok_ent_sgtid_fk" FOREIGN KEY ("server_group_type_id") REFERENCES "rhnservergrouptype" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageprovides" ADD CONSTRAINT "rhn_pkg_provides_package_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackageprovides" ADD CONSTRAINT "rhn_pkg_provides_capability_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_parameter" ADD CONSTRAINT "rhn_cparm_cmd_command_id_fk" FOREIGN KEY ("command_id") REFERENCES "rhn_command" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_parameter" ADD CONSTRAINT "rhn_cparm_sdtyp_name_fk" FOREIGN KEY ("data_type_name") REFERENCES "rhn_semantic_data_type" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_parameter" ADD CONSTRAINT "rhn_cparm_wdgt_fld_wdgt_n_fk" FOREIGN KEY ("field_widget_name") REFERENCES "rhn_widget" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtvcpu" ADD CONSTRAINT "rhn_avcpu_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroupmembers" ADD CONSTRAINT "rhn_sg_members_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroupmembers" ADD CONSTRAINT "rhn_sg_groups_fk" FOREIGN KEY ("server_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatelliteservergroup" ADD CONSTRAINT "rhn_satsg_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnsatelliteinfo" ("server_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsatelliteservergroup" ADD CONSTRAINT "rhn_satsg_sgtype_fk" FOREIGN KEY ("server_group_type") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroup" ADD CONSTRAINT "rhn_servergroup_type_fk" FOREIGN KEY ("group_type") REFERENCES "rhnservergrouptype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservergroup" ADD CONSTRAINT "rhn_servergroup_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackage" ADD CONSTRAINT "rhn_cnp_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackage" ADD CONSTRAINT "rhn_cnp_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackage" ADD CONSTRAINT "rhn_cnp_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackage" ADD CONSTRAINT "rhn_cnp_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackage" ADD CONSTRAINT "rhn_cnp_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilymembers" ADD CONSTRAINT "rhn_cf_members_c_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamilymembers" ADD CONSTRAINT "rhn_cf_family_fk" FOREIGN KEY ("channel_family_id") REFERENCES "rhnchannelfamily" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionkickstartfilelist" ADD CONSTRAINT "rhn_actionksfl_askid_fk" FOREIGN KEY ("action_ks_id") REFERENCES "rhnactionkickstart" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionkickstartfilelist" ADD CONSTRAINT "rhn_actionksfl_flid_fk" FOREIGN KEY ("file_list_id") REFERENCES "rhnfilelist" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgquota" ADD CONSTRAINT "rhn_orgquota_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsnpserverqueue" ADD CONSTRAINT "rhn_sec_np_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_pnid_fk" FOREIGN KEY ("package_name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_peid_fk" FOREIGN KEY ("package_evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveractionverifymissing" ADD CONSTRAINT "rhn_sactionvm_pcid_fk" FOREIGN KEY ("package_capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigrevisionresult" ADD CONSTRAINT "rhn_actioncfr_acrid_fk" FOREIGN KEY ("action_config_revision_id") REFERENCES "rhnactionconfigrevision" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackagearchcompat" ADD CONSTRAINT "rhn_sp_ac_said_fk" FOREIGN KEY ("server_arch_id") REFERENCES "rhnserverarch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackagearchcompat" ADD CONSTRAINT "rhn_sp_ac_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofile" ADD CONSTRAINT "rhn_server_profile_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofile" ADD CONSTRAINT "rhn_server_profile_bcid_fk" FOREIGN KEY ("base_channel") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverprofile" ADD CONSTRAINT "rhn_server_profile_ptype_fk" FOREIGN KEY ("profile_type_id") REFERENCES "rhnserverprofiletype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfiledownload" ADD CONSTRAINT "rhn_filedl_fid_fk" FOREIGN KEY ("file_id") REFERENCES "rhnfile" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnfiledownload" ADD CONSTRAINT "rhn_filedl_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratanotificationqueue" ADD CONSTRAINT "rhn_enqueue_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratanotificationqueue" ADD CONSTRAINT "rhn_enqueue_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsavedsearch" ADD CONSTRAINT "rhn_savedsearch_wcid_fk" FOREIGN KEY ("web_contact_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsavedsearch" ADD CONSTRAINT "rhn_savedsearch_type_fk" FOREIGN KEY ("type") REFERENCES "rhnsavedsearchtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenchannels" ADD CONSTRAINT "rhn_reg_tok_chn_id_fk" FOREIGN KEY ("token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenchannels" ADD CONSTRAINT "rhn_reg_tok_chn_sgs_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserserverperms" ADD CONSTRAINT "rhn_usperms_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserserverperms" ADD CONSTRAINT "rhn_usperms_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_group_fk" FOREIGN KEY ("package_group") REFERENCES "rhnpackagegroup" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackage" ADD CONSTRAINT "rhn_package_srcrpmid_fk" FOREIGN KEY ("source_rpm_id") REFERENCES "rhnsourcerpm" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceinfo" ADD CONSTRAINT "rhn_vii_viid_fk" FOREIGN KEY ("instance_id") REFERENCES "rhnvirtualinstance" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceinfo" ADD CONSTRAINT "rhn_vii_it_fk" FOREIGN KEY ("instance_type") REFERENCES "rhnvirtualinstancetype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnvirtualinstanceinfo" ADD CONSTRAINT "rhn_vii_state_fk" FOREIGN KEY ("state") REFERENCES "rhnvirtualinstancestate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpathchannelmap" ADD CONSTRAINT "rhn_path_channel_map_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnproduct" ADD CONSTRAINT "rhn_product_cat_fk" FOREIGN KEY ("product_line_id") REFERENCES "rhnproductline" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigrevision" ADD CONSTRAINT "rhn_confrevision_cfid_fk" FOREIGN KEY ("config_file_id") REFERENCES "rhnconfigfile" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigrevision" ADD CONSTRAINT "rhn_confrevision_ccid_fk" FOREIGN KEY ("config_content_id") REFERENCES "rhnconfigcontent" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigrevision" ADD CONSTRAINT "rhn_confrevision_ciid_fk" FOREIGN KEY ("config_info_id") REFERENCES "rhnconfiginfo" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigrevision" ADD CONSTRAINT "rhn_conf_rev_cfti_fk" FOREIGN KEY ("config_file_type_id") REFERENCES "rhnconfigfiletype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnconfigrevision" ADD CONSTRAINT "rhn_confrevision_cid_fk" FOREIGN KEY ("changed_by_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_group_targets" ADD CONSTRAINT "rhn_rdrgt_rdrct_redirect_id_fk" FOREIGN KEY ("redirect_id") REFERENCES "rhn_redirects" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelerrata" ADD CONSTRAINT "rhn_ce_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelerrata" ADD CONSTRAINT "rhn_ce_eid_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtschedulepoller" ADD CONSTRAINT "rhn_avsp_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtsetmemory" ADD CONSTRAINT "rhn_avsm_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionerrataupdate" ADD CONSTRAINT "rhn_act_eu_act_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionerrataupdate" ADD CONSTRAINT "rhn_act_eu_err_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgchannelsettings" ADD CONSTRAINT "rhn_orgcsettings_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgchannelsettings" ADD CONSTRAINT "rhn_orgcsettings_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnorgchannelsettings" ADD CONSTRAINT "rhn_orgcsettings_sid_fk" FOREIGN KEY ("setting_id") REFERENCES "rhnorgchannelsettingstype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserveruuid" ADD CONSTRAINT "rhn_server_uuid_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirect_email_targets" ADD CONSTRAINT "rhn_rdret_rdrct_redirect_id_fk" FOREIGN KEY ("redirect_id") REFERENCES "rhn_redirects" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_schedule_weeks" ADD CONSTRAINT "rhn_schwk_sched_comp_sched_fk" FOREIGN KEY ("component_schedule_id") REFERENCES "rhn_schedules" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_schedule_weeks" ADD CONSTRAINT "rhn_schwk_sched_sched_id_fk" FOREIGN KEY ("schedule_id") REFERENCES "rhn_schedules" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command" ADD CONSTRAINT "rhn_cmmnd_cmdgr_group_name_fk" FOREIGN KEY ("group_name") REFERENCES "rhn_command_groups" ("group_name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command" ADD CONSTRAINT "rhn_cmmnd_comcl_class_name_fk" FOREIGN KEY ("command_class") REFERENCES "rhn_command_class" ("class_name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command" ADD CONSTRAINT "rhn_cmmnd_sys_reqs_fk" FOREIGN KEY ("system_requirements") REFERENCES "rhn_command_requirements" ("name") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispatchset" ADD CONSTRAINT "rhn_solaris_ps_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnmonitor" ADD CONSTRAINT "rhn_monitor_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnmonitor" ADD CONSTRAINT "rhn_monitor_granularity_fk" FOREIGN KEY ("granularity") REFERENCES "rhnmonitorgranularity" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenpackages" ADD CONSTRAINT "rhn_reg_tok_pkg_id_fk" FOREIGN KEY ("token_id") REFERENCES "rhnregtoken" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenpackages" ADD CONSTRAINT "rhn_reg_tok_pkg_sgs_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnregtokenpackages" ADD CONSTRAINT "rhn_reg_tok_pkg_aid_fk" FOREIGN KEY ("arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_customer_notification" ADD CONSTRAINT "web_cust_not_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverlock" ADD CONSTRAINT "rhn_server_lock_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverlock" ADD CONSTRAINT "rhn_server_lock_lid_fk" FOREIGN KEY ("locker_id") REFERENCES "web_contact" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafile" ADD CONSTRAINT "rhn_erratafile_errata_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafile" ADD CONSTRAINT "rhn_erratafile_type_fk" FOREIGN KEY ("type") REFERENCES "rhnerratafiletype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirects" ADD CONSTRAINT "rhn_rdrct_cntct_contact_id_fk" FOREIGN KEY ("contact_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirects" ADD CONSTRAINT "rhn_rdrct_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_redirects" ADD CONSTRAINT "rhn_rdrct_rdrtp_redir_type_fk" FOREIGN KEY ("redirect_type") REFERENCES "rhn_redirect_types" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionelement" ADD CONSTRAINT "rhn_transelem_tid_fk" FOREIGN KEY ("transaction_id") REFERENCES "rhntransaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransactionelement" ADD CONSTRAINT "rhn_transelem_tpid_fk" FOREIGN KEY ("transaction_package_id") REFERENCES "rhntransactionpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagedeltaelement" ADD CONSTRAINT "rhn_pdelement_pdid_fk" FOREIGN KEY ("package_delta_id") REFERENCES "rhnpackagedelta" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagedeltaelement" ADD CONSTRAINT "rhn_pdelement_tpid_fk" FOREIGN KEY ("transaction_package_id") REFERENCES "rhntransactionpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtdestroy" ADD CONSTRAINT "rhn_avd_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_ll_netsaint" ADD CONSTRAINT "rhn_llnts_sat_cluster_idfk" FOREIGN KEY ("netsaint_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratacloned" ADD CONSTRAINT "rhn_errataclone_feid_fk" FOREIGN KEY ("original_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratacloned" ADD CONSTRAINT "rhn_errataclone_teid_fk" FOREIGN KEY ("id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionkickstartguest" ADD CONSTRAINT "rhn_actionks_xenguest_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionkickstartguest" ADD CONSTRAINT "rhn_actionks_xenguest_ksid_fk" FOREIGN KEY ("ks_session_id") REFERENCES "rhnkickstartsession" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservernetwork" ADD CONSTRAINT "rhn_servernetwork_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnsolarispackage" ADD CONSTRAINT "rhn_solaris_pkg_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackagesource" ADD CONSTRAINT "rhn_efileps_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackagesource" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackagesource" ADD CONSTRAINT "rhn_efileps_fileid_fk" FOREIGN KEY ("errata_file_id") REFERENCES "rhnerratafile" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_notification_formats" ADD CONSTRAINT "rhn_ntfmt_customer_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpermission" ADD CONSTRAINT "rhn_cperm_cidffk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpermission" ADD CONSTRAINT "rhn_cperm_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelpermission" ADD CONSTRAINT "rhn_cperm_rid_fk" FOREIGN KEY ("role_id") REFERENCES "rhnchannelpermissionrole" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerrata" ADD CONSTRAINT "rhn_errata_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerrata" ADD CONSTRAINT "rhn_errata_sevid_fk" FOREIGN KEY ("severity_id") REFERENCES "rhnerrataseverity" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagefile" ADD CONSTRAINT "rhn_package_file_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagefile" ADD CONSTRAINT "rhn_package_file_cid_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_cluster_probe" ADD CONSTRAINT "rhn_sclpb_prb_recid_prb_typ_fk" FOREIGN KEY ("probe_id","probe_type") REFERENCES "rhn_probe" ("recid","probe_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_cluster_probe" ADD CONSTRAINT "rhn_sclpb_satcl_sat_cl_id_fk" FOREIGN KEY ("sat_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnemailaddress" ADD CONSTRAINT "rhn_eaddress_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnemailaddress" ADD CONSTRAINT "rhn_eaddress_sid_fk" FOREIGN KEY ("state_id") REFERENCES "rhnemailaddressstate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelfamily" ADD CONSTRAINT "rhn_channel_family_org_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_contact" ADD CONSTRAINT "web_contact_org_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartabletree" ADD CONSTRAINT "rhn_kstree_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartabletree" ADD CONSTRAINT "rhn_kstree_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartabletree" ADD CONSTRAINT "rhn_kstree_kstreetype_fk" FOREIGN KEY ("kstree_type") REFERENCES "rhnkstreetype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartabletree" ADD CONSTRAINT "rhn_kstree_it_fk" FOREIGN KEY ("install_type") REFERENCES "rhnksinstalltype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservernetinterface" ADD CONSTRAINT "rhn_srv_net_iface_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratabuglist" ADD CONSTRAINT "rhn_errata_buglist_errata_fk" FOREIGN KEY ("errata_id") REFERENCES "rhnerrata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_cluster" ADD CONSTRAINT "rhn_satcl_cmdtg_recid_tar_fk" FOREIGN KEY ("recid","target_type") REFERENCES "rhn_command_target" ("recid","target_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_cluster" ADD CONSTRAINT "rhn_satcl_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_sat_cluster" ADD CONSTRAINT "rhn_satcl_phslc_phys_loc_fk" FOREIGN KEY ("physical_location_id") REFERENCES "rhn_physical_location" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnarchtypeactions" ADD CONSTRAINT "rhn_archtypeacts_atid_fk" FOREIGN KEY ("arch_type_id") REFERENCES "rhnarchtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnarchtypeactions" ADD CONSTRAINT "rhn_archtypeacts_actid_fk" FOREIGN KEY ("action_type_id") REFERENCES "rhnactiontype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelnewestpackageaudit" ADD CONSTRAINT "rhn_cnp_at_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnproductchannel" ADD CONSTRAINT "rhn_pc_cid_fk" FOREIGN KEY ("channel_id") REFERENCES "rhnchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnproductchannel" ADD CONSTRAINT "rhn_pc_pid_fk" FOREIGN KEY ("product_id") REFERENCES "rhnproduct" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagerequires" ADD CONSTRAINT "rhn_pkg_requires_package_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagerequires" ADD CONSTRAINT "rhn_pkg_requires_capability_fk" FOREIGN KEY ("capability_id") REFERENCES "rhnpackagecapability" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigchannel" ADD CONSTRAINT "rhn_actioncc_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigchannel" ADD CONSTRAINT "rhn_actioncc_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigchannel" ADD CONSTRAINT "rhn_actioncc_ccid_fk" FOREIGN KEY ("config_channel_id") REFERENCES "rhnconfigchannel" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigchannel" ADD CONSTRAINT "rhn_actioncc_sid_aid_fk" FOREIGN KEY ("server_id","action_id") REFERENCES "rhnserveraction" ("server_id","action_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_queue_params" ADD CONSTRAINT "rhn_cqprm_cqins_instance_id_fk" FOREIGN KEY ("instance_id") REFERENCES "rhn_command_queue_instances" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsessionhistory" ADD CONSTRAINT "rhn_ks_sessionhist_ksid_fk" FOREIGN KEY ("kickstart_session_id") REFERENCES "rhnkickstartsession" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsessionhistory" ADD CONSTRAINT "rhn_ks_sessionhist_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartsessionhistory" ADD CONSTRAINT "rhn_ks_sessionhist_stat_fk" FOREIGN KEY ("state_id") REFERENCES "rhnkickstartsessionstate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_host_check_suites" ADD CONSTRAINT "rhn_hstck_cksut_suite_id_fk" FOREIGN KEY ("suite_id") REFERENCES "rhn_check_suites" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_host_check_suites" ADD CONSTRAINT "rhn_hstck_hstpb_probe_id_fk" FOREIGN KEY ("host_probe_id") REFERENCES "rhn_host_probe" ("probe_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_host_probe" ADD CONSTRAINT "rhn_hstpb_host_id_fk" FOREIGN KEY ("host_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_host_probe" ADD CONSTRAINT "rhn_hstpb_probe_probe_id_fk" FOREIGN KEY ("probe_id","probe_type") REFERENCES "rhn_probe" ("recid","probe_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_host_probe" ADD CONSTRAINT "rhn_hstpb_satcl_id_fk" FOREIGN KEY ("sat_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartiprange" ADD CONSTRAINT "rhn_ksip_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartiprange" ADD CONSTRAINT "rhn_ksip_oid_fk" FOREIGN KEY ("org_id") REFERENCES "web_customer" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservermessage" ADD CONSTRAINT "rhn_sm_server_id_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservermessage" ADD CONSTRAINT "rhn_sm_message_id_fk" FOREIGN KEY ("message_id") REFERENCES "rhnmessage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnservermessage" ADD CONSTRAINT "rhn_sm_se_fk" FOREIGN KEY ("server_event") REFERENCES "rhnserverevent" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionvirtsuspend" ADD CONSTRAINT "rhn_avsuspend_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnmessage" ADD CONSTRAINT "rhn_m_mt_fk" FOREIGN KEY ("message_type") REFERENCES "rhnmessagetype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnmessage" ADD CONSTRAINT "rhn_m_priority_fk" FOREIGN KEY ("priority") REFERENCES "rhnmessagepriority" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhntransaction" ADD CONSTRAINT "rhn_trans_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackagetmp" ADD CONSTRAINT "rhn_efileptmp_pid_fk" FOREIGN KEY ("package_id") REFERENCES "rhnpackage" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnerratafilepackagetmp" ADD CONSTRAINT "rhn_efileptmp_fileid_fk" FOREIGN KEY ("errata_file_id") REFERENCES "rhnerratafiletmp" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaults" ADD CONSTRAINT "rhn_ksd_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaults" ADD CONSTRAINT "rhn_ksd_kstid_fk" FOREIGN KEY ("kstree_id") REFERENCES "rhnkickstartabletree" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaults" ADD CONSTRAINT "rhn_ksd_spid_fk" FOREIGN KEY ("server_profile_id") REFERENCES "rhnserverprofile" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartdefaults" ADD CONSTRAINT "rhn_ksd_kvt_fk" FOREIGN KEY ("virtualization_type") REFERENCES "rhnkickstartvirtualizationtype" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "pxtsessions" ADD CONSTRAINT "pxtsessions_user" FOREIGN KEY ("web_user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagearch" ADD CONSTRAINT "rhn_parch_atid_fk" FOREIGN KEY ("arch_type_id") REFERENCES "rhnarchtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagenevra" ADD CONSTRAINT "rhn_pkgnevra_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagenevra" ADD CONSTRAINT "rhn_pkgnevra_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpackagenevra" ADD CONSTRAINT "rhn_pkgnevra_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigfilename" ADD CONSTRAINT "rhn_actioncf_name_cfnid_fk" FOREIGN KEY ("config_file_name_id") REFERENCES "rhnconfigfilename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigfilename" ADD CONSTRAINT "rhn_actioncf_name_crid_fk" FOREIGN KEY ("config_revision_id") REFERENCES "rhnconfigrevision" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigfilename" ADD CONSTRAINT "rhn_actioncf_failure_id_fk" FOREIGN KEY ("failure_id") REFERENCES "rhnconfigfilefailure" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigfilename" ADD CONSTRAINT "rhn_actioncf_name_aid_sid_fk" FOREIGN KEY ("server_id","action_id") REFERENCES "rhnserveraction" ("server_id","action_id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnappinstallsession" ADD CONSTRAINT "rhn_appinst_session_iid_fk" FOREIGN KEY ("instance_id") REFERENCES "rhnappinstallinstance" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnappinstallsession" ADD CONSTRAINT "rhn_appinst_session_uid_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnappinstallsession" ADD CONSTRAINT "rhn_appinst_session_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_queue_execs" ADD CONSTRAINT "rhn_cqexe_cqins_inst_id_fk" FOREIGN KEY ("instance_id") REFERENCES "rhn_command_queue_instances" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_command_queue_execs" ADD CONSTRAINT "rhn_cqexe_satcl_nsaint_id_fk" FOREIGN KEY ("netsaint_id","target_type") REFERENCES "rhn_command_target" ("recid","target_type") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnchannelarch" ADD CONSTRAINT "rhn_carch_atid_fk" FOREIGN KEY ("arch_type_id") REFERENCES "rhnarchtype" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_check_suite_probe" ADD CONSTRAINT "rhn_ckspb_cksut_ck_suite_id_fk" FOREIGN KEY ("check_suite_id") REFERENCES "rhn_check_suites" ("recid") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_groups" ADD CONSTRAINT "rhn_cntgp_cstmr_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "web_customer" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_groups" ADD CONSTRAINT "rhn_cntgp_strat_strategy_id_fk" FOREIGN KEY ("strategy_id") REFERENCES "rhn_strategies" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_groups" ADD CONSTRAINT "rhn_ntfmt_cntgp_id_fk" FOREIGN KEY ("notification_format_id") REFERENCES "rhn_notification_formats" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnblacklistobsoletes" ADD CONSTRAINT "rhn_bl_obs_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnblacklistobsoletes" ADD CONSTRAINT "rhn_bl_obs_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnblacklistobsoletes" ADD CONSTRAINT "rhn_bl_obs_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnblacklistobsoletes" ADD CONSTRAINT "rhn_bl_obs_inid_fk" FOREIGN KEY ("ignore_name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_contact_id_fk" FOREIGN KEY ("contact_id") REFERENCES "web_contact" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_method_type_id_fk" FOREIGN KEY ("method_type_id") REFERENCES "rhn_method_types" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_pager_type_id_fk" FOREIGN KEY ("pager_type_id") REFERENCES "rhn_pager_types" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_sender_sat_clus_fk" FOREIGN KEY ("sender_sat_cluster_id") REFERENCES "rhn_sat_cluster" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_schedule_id_fk" FOREIGN KEY ("schedule_id") REFERENCES "rhn_schedules" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_contact_methods" ADD CONSTRAINT "rhn_cmeth_ntfmt_id_fk" FOREIGN KEY ("notification_format_id") REFERENCES "rhn_notification_formats" ("recid") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhn_config_macro" ADD CONSTRAINT "rhn_confm_envir_environment_fk" FOREIGN KEY ("environment") REFERENCES "rhn_environment" ("name") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_user_site_info" ADD CONSTRAINT "wusi_wuid_fk" FOREIGN KEY ("web_user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "web_user_site_info" ADD CONSTRAINT "wusi_type_fk" FOREIGN KEY ("type") REFERENCES "web_user_site_type" ("type") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserservergroupperms" ADD CONSTRAINT "rhn_usgp_user_fk" FOREIGN KEY ("user_id") REFERENCES "web_contact" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnuserservergroupperms" ADD CONSTRAINT "rhn_usgp_server_fk" FOREIGN KEY ("server_group_id") REFERENCES "rhnservergroup" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhndevice" ADD CONSTRAINT "rhn_device_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartpackage" ADD CONSTRAINT "rhn_kspackage_ksid_fk" FOREIGN KEY ("kickstart_id") REFERENCES "rhnksdata" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnkickstartpackage" ADD CONSTRAINT "rhn_kspackage_pnid_fk" FOREIGN KEY ("package_name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnpushclient" ADD CONSTRAINT "sys_c009070" FOREIGN KEY ("state_id") REFERENCES "rhnpushclientstate" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigrevision" ADD CONSTRAINT "rhn_actioncr_aid_fk" FOREIGN KEY ("action_id") REFERENCES "rhnaction" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigrevision" ADD CONSTRAINT "rhn_actioncr_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigrevision" ADD CONSTRAINT "rhn_actioncr_crid_fk" FOREIGN KEY ("config_revision_id") REFERENCES "rhnconfigrevision" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnactionconfigrevision" ADD CONSTRAINT "rhn_actioncr_failid_fk" FOREIGN KEY ("failure_id") REFERENCES "rhnconfigfilefailure" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackage" ADD CONSTRAINT "rhn_serverpackage_sid_fk" FOREIGN KEY ("server_id") REFERENCES "rhnserver" ("id") ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackage" ADD CONSTRAINT "rhn_serverpackage_nid_fk" FOREIGN KEY ("name_id") REFERENCES "rhnpackagename" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackage" ADD CONSTRAINT "rhn_serverpackage_eid_fk" FOREIGN KEY ("evr_id") REFERENCES "rhnpackageevr" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "rhnserverpackage" ADD CONSTRAINT "rhn_serverpackage_paid_fk" FOREIGN KEY ("package_arch_id") REFERENCES "rhnpackagearch" ("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
...
CREATE SEQUENCE "rhn_command_q_comm_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 120 CACHE 20;
CREATE SEQUENCE "rhn_sourcerpm_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1821 CACHE 20;
CREATE SEQUENCE "rhn_schedule_weeks_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_snmp_alert_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_confchantype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_cfname_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_kstree_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_filelist_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_appinst_instance_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_appinst_sdata_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_erratafile_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_tagname_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_cpu_arch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 260 CACHE 20;
CREATE SEQUENCE "rhn_cryptokeytype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_cve_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 461 CACHE 20;
CREATE SEQUENCE "rhn_faq_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_kscommand_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 221 CACHE 20;
CREATE SEQUENCE "rhn_monitorgranularity_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_pkey_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 120 CACHE 20;
CREATE SEQUENCE "rhn_pclient_state_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_sstype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_server_dmi_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 62 CACHE 20;
CREATE SEQUENCE "rhn_template_cat_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_vit_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "web_user_site_info_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 781 CACHE 20;
CREATE SEQUENCE "rhn_channelprod_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_channel_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 341 CACHE 20;
CREATE SEQUENCE "rhn_package_arch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 160 CACHE 20;
CREATE SEQUENCE "rhn_commands_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 305 CACHE 20;
CREATE SEQUENCE "rhn_check_suites_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_pager_types_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_schedules_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_timezone_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 7040 CACHE 20;
CREATE SEQUENCE "rhn_redirect_types_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_packagedelta_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_pkg_capability_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1016801 CACHE 20;
CREATE SEQUENCE "rhn_transaction_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_pkgnevra_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 4341 CACHE 20;
CREATE SEQUENCE "rhn_ssinvalid_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_snapshot_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_package_source_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 61 CACHE 20;
CREATE SEQUENCE "rhn_usergroup_type_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_info_pane_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_ksscript_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_package_provider_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 120 CACHE 20;
CREATE SEQUENCE "rhn_um_status_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_viel_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_command_q_inst_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_server_arch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1040 CACHE 20;
CREATE SEQUENCE "rhn_redirects_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_ks_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 81 CACHE 20;
CREATE SEQUENCE "rhn_cpu_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 82 CACHE 20;
CREATE SEQUENCE "rhn_faq_class_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 101 CACHE 20;
CREATE SEQUENCE "rhn_m_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_monitor_bid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_viil_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_reg_tok_pkg_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "web_contact_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 801 CACHE 20;
CREATE SEQUENCE "rhn_server_group_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 381 CACHE 20;
CREATE SEQUENCE "rhn_pkg_name_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 2541 CACHE 20;
CREATE SEQUENCE "rhn_pkg_evr_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1981 CACHE 20;
CREATE SEQUENCE "rhn_probes_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_ntfmt_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_contact_methods_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_confcontent_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_confrevision_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_actioncr_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_actionks_xenguest_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_actscript_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_channelcomps_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 101 CACHE 20;
CREATE SEQUENCE "rhn_cryptokey_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_m_priority_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_ocstngs_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_reltype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_solaris_pt_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_vis_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_vii_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_channel_family_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1080 CACHE 20;
CREATE SEQUENCE "rhn_provstate_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 141 CACHE 20;
CREATE SEQUENCE "rhn_server_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1000010201 CACHE 20;
CREATE SEQUENCE "rhn_package_group_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 241 CACHE 20;
CREATE SEQUENCE "rhn_command_target_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 81 CACHE 20;
CREATE SEQUENCE "rhn_physical_loc_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_confinfo_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_ksinstalltype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_reg_token_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 61 CACHE 20;
CREATE SEQUENCE "rhn_appinst_session_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_file_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_cdatakey_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_hw_dev_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1431 CACHE 20;
CREATE SEQUENCE "rhn_eaddress_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_erratafile_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 25921 CACHE 20;
CREATE SEQUENCE "rhn_ks_sessionhist_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_product_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 101 CACHE 20;
CREATE SEQUENCE "rhn_server_package_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_template_str_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_user_group_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1881 CACHE 20;
CREATE SEQUENCE "rhn_wcon_change_state_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_wcon_disabled_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "web_customer_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 262 CACHE 20;
CREATE SEQUENCE "rhn_channel_arch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 520 CACHE 20;
CREATE SEQUENCE "rhn_productname_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 141 CACHE 20;
CREATE SEQUENCE "rhn_schedule_types_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_contact_groups_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_host_probes_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_redirect_crit_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_url_probe_step_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_confchan_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_kstree_type_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_eastate_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_grail_components_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_kscommandname_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 61 CACHE 20;
CREATE SEQUENCE "rhn_ks_timezone_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1501 CACHE 20;
CREATE SEQUENCE "rhn_mt_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_org_entitlement_type_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_pkg_cl_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 414901 CACHE 20;
CREATE SEQUENCE "rhn_pclient_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_servergrp_note_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_server_loc_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_server_net_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 82 CACHE 20;
CREATE SEQUENCE "rhn_server_note_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_archtype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_package_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 4401 CACHE 20;
CREATE SEQUENCE "rhn_strategies_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "pxt_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1183 CACHE 20;
CREATE SEQUENCE "rhn_event_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 406 CACHE 20;
CREATE SEQUENCE "rhn_cfstate_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_conffile_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_server_profile_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_kvt_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 61 CACHE 20;
CREATE SEQUENCE "rhn_ks_session_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_tag_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_download_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_virt_sl_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_cperm_role_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_package_key_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 120 CACHE 20;
CREATE SEQUENCE "rhn_pushdispatch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_savedsearch_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_se_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_solaris_ps_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_viet_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "web_cust_notif_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1000000 CACHE 20;
CREATE SEQUENCE "rhn_servergroup_type_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_current_alerts_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_schedule_days_recid_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_conffile_failure_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_errata_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 701 CACHE 20;
CREATE SEQUENCE "rhn_actionks_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_ks_session_state_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_sproftype_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_act_p_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_client_capname_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 41 CACHE 20;
CREATE SEQUENCE "rhn_feature_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 41 CACHE 20;
CREATE SEQUENCE "rhn_transpack_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 21 CACHE 20;
CREATE SEQUENCE "rhn_prod_line_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 101 CACHE 20;
CREATE SEQUENCE "rhn_ram_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 202 CACHE 20;
CREATE SEQUENCE "rhn_server_install_info_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 1 CACHE 20;
CREATE SEQUENCE "rhn_vi_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 2147483646 START 41 CACHE 20;
