...
insert into rhn_config_parameter(group_name,name,value,security_type,last_update_user,last_update_date) values ( 'notification', 'ack_handler_log', '/var/log/nocpulse/ack_handler.log', 'INTERNAL', 'system',current_date);
...
insert into rhn_config_parameter(group_name,name,value,security_type,last_update_user,last_update_date) values ( 'notification', 'enqueue_log', '/var/log/nocpulse/enqueue.log', 'INTERNAL', 'system',current_date);
