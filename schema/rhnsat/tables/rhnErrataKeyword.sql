...
(
	errata_id       number
			constraint rhn_err_keyword_eid_nn not null
			constraint rhn_err_keyword_eid_fk
				references rhnErrata(id)
				on delete cascade,
	keyword		varchar2(64),
	created		date default(sysdate)
			constraint rhn_err_keyword_created_nn not null,
...
--
-- Revision 1.12  2004/10/29 18:11:46  pjones
-- bugzilla: 137474 -- triggers to maintain last_modified everywhere
--
-- Revision 1.11  2003/08/19 14:51:51  uid2174
-- bugzilla: 102263
--
-- indices
--
