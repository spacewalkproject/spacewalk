...
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_ADMIN_EMAIL', '**RHN_ADMIN_EMAIL**', 'RHN Satellite administrator email', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_DB_NAME', '**RHN_DB_NAME**', 'RHN database name ', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_DB_PASSWD', '**RHN_DB_PASSWD**', 'RHN database password', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_DB_TABLE_OWNER', '**RHN_DB_TABLE_OWNER**', 'RHN Database table owner', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_DB_USERNAME', '**RHN_DB_USERNAME**', 'RHN database username', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_SAT_HOSTNAME', '**RHN_SAT_HOSTNAME**', 'RHN Satellite hostname (FQDN)', '1', 'system',sysdate);
insert into rhn_config_macro(environment,name,definition,description,editable,last_update_user,last_update_date)     values ( 'LICENSE', 'RHN_SAT_WEB_PORT', '**RHN_SAT_WEB_PORT**', 'RHN Satellite webserver port (80 for http, 443 for https)', '1', 'system',sysdate);
