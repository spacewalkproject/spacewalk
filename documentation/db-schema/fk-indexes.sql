...
create index fk_no_index_16 on RHNAPPINSTALLSESSION (CHECKSUM_ID);

--missed index on RHNARCHTYPEACTIONS table for RHN_ARCHTYPEACTS_ACTID_FK constraint 
create index fk_no_index_17 on RHNARCHTYPEACTIONS (ACTION_TYPE_ID);
...
create index fk_no_index_23 on RHNCHANNELCONTENTSOURCE (CHANNEL_ID);

--missed index on RHNCHANNELDOWNLOADS table for RHN_CD_DID_FK constraint 
create index fk_no_index_24 on RHNCHANNELDOWNLOADS (DOWNLOADS_ID);
...
create index fk_no_index_27 on RHNCHANNELNEWESTPACKAGE (NAME_ID);
...
create index fk_no_index_29 on RHNCHANNELPACKAGEARCHCOMPAT (PACKAGE_ARCH_ID);
