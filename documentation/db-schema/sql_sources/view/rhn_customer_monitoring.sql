...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE OR REPLACE FORCE VIEW "MIM_H1"."RHN_CUSTOMER_MONITORING" ("RECID", "DESCRIPTION", "SCHEDULE_ID", "DEF_ACK_WAIT", "DEF_STRATEGY", "PREFERRED_TIME_ZONE", "AUTO_UPDATE") AS 
  select	org.id			recid,
