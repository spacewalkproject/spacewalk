...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "MIM1"."RHN_CONTACT_GROUP_MEMBERS" 
   (	"CONTACT_GROUP_ID" NUMBER(12,0) NOT NULL ENABLE, 
	"ORDER_NUMBER" NUMBER NOT NULL ENABLE, 
	"MEMBER_CONTACT_METHOD_ID" NUMBER(12,0), 
	"MEMBER_CONTACT_GROUP_ID" NUMBER(12,0), 
  ...
  TABLESPACE "DATA_TBS"  ENABLE, 
	 CONSTRAINT "RHN_CNTGM_CGID_FK" FOREIGN KEY ("CONTACT_GROUP_ID")
	  REFERENCES "MIM1"."RHN_CONTACT_GROUPS" ("RECID") ON DELETE CASCADE ENABLE, 
