...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "MIM1"."RHN_COMMAND_PARAM_THRESHOLD" 
  ...
  TABLESPACE "DATA_TBS"  ENABLE, 
	 CONSTRAINT "RHN_COPTR_CMD_ID_CMD_CL_FK" FOREIGN KEY ("COMMAND_ID", "COMMAND_CLASS")
	  REFERENCES "MIM1"."RHN_COMMAND" ("RECID", "COMMAND_CLASS") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "RHN_COPTR_M_THR_M_CMD_CL_FK" FOREIGN KEY ("COMMAND_CLASS", "THRESHOLD_METRIC_ID")
	  REFERENCES "MIM1"."RHN_METRICS" ("COMMAND_CLASS", "METRIC_ID") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "RHN_COPTR_THRTP_THRES_TYPE_FK" FOREIGN KEY ("THRESHOLD_TYPE_NAME")
	  REFERENCES "MIM1"."RHN_THRESHOLD_TYPE" ("NAME") ENABLE
