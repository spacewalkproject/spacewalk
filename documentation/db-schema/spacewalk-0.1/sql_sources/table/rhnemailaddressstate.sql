...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNEMAILADDRESSSTATE" 
   (	"ID" NUMBER CONSTRAINT "RHN_EASTATE_ID_NN" NOT NULL ENABLE, 
	"LABEL" VARCHAR2(32) CONSTRAINT "RHN_EASTATE_LABEL_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EASTATE_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EASTATE_MODIFIED_NN" NOT NULL ENABLE, 
