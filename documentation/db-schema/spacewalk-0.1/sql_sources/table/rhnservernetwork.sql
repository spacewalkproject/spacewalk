...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNSERVERNETWORK" 
   (	"ID" NUMBER CONSTRAINT "RHN_SERVERNETWORK_ID_NN" NOT NULL ENABLE, 
	"SERVER_ID" NUMBER CONSTRAINT "RHN_SERVERNETWORK_SID_NN" NOT NULL ENABLE, 
	"HOSTNAME" VARCHAR2(128), 
	"IPADDR" CHAR(16), 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_SERVERNETWORK_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_SERVERNETWORK_MODIFIED_NN" NOT NULL ENABLE, 
