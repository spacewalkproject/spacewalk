...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNREGTOKENGROUPS" 
   (	"TOKEN_ID" NUMBER CONSTRAINT "RHN_REG_TOK_GRP_TID_NN" NOT NULL ENABLE, 
	"SERVER_GROUP_ID" NUMBER CONSTRAINT "RHN_REG_TOK_GRP_SG_NN" NOT NULL ENABLE, 
