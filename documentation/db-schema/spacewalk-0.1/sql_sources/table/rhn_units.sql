...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHN_UNITS" 
   (	"UNIT_ID" VARCHAR2(10) CONSTRAINT "RHN_UNITS_UNIT_ID_NN" NOT NULL ENABLE, 
	"QUANTUM_ID" VARCHAR2(10) CONSTRAINT "RHN_UNITS_QUANTUM_ID_NN" NOT NULL ENABLE, 
  ...
  TABLESPACE "DATA_TBS"  ENABLE, 
	 CONSTRAINT "RHN_UNITS_QNTA0_QUANTUM_ID_FK" FOREIGN KEY ("QUANTUM_ID")
	  REFERENCES "RHNSAT"."RHN_QUANTA" ("QUANTUM_ID") ENABLE
