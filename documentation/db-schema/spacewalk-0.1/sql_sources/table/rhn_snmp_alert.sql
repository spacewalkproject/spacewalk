...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHN_SNMP_ALERT" 
   (	"RECID" NUMBER(12,0) CONSTRAINT "RHN_SNMPA_RECID_NN" NOT NULL ENABLE, 
	"SENDER_CLUSTER_ID" NUMBER(12,0) CONSTRAINT "RHN_SNMPA_SEND_CLUST_ID_NN" NOT NULL ENABLE, 
	"DEST_IP" VARCHAR2(255) CONSTRAINT "RHN_SNMPA_DEST_IP_NN" NOT NULL ENABLE, 
	"DEST_PORT" NUMBER(5,0) CONSTRAINT "RHN_SNMPA_DEST_PORT_NN" NOT NULL ENABLE, 
	"DATE_GENERATED" DATE, 
	"DATE_SUBMITTED" DATE, 
