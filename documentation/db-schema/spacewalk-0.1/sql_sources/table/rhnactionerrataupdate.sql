...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNACTIONERRATAUPDATE" 
   (	"ACTION_ID" NUMBER CONSTRAINT "RHN_ACT_EU_ACT_NN" NOT NULL ENABLE, 
	"ERRATA_ID" NUMBER CONSTRAINT "RHN_ACT_EU_ERR_NN" NOT NULL ENABLE, 
