...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNERRATAFILECHANNELTMP" 
   (	"CHANNEL_ID" NUMBER CONSTRAINT "RHN_EFILECTMP_CID_NN" NOT NULL ENABLE, 
	"ERRATA_FILE_ID" NUMBER CONSTRAINT "RHN_EFILECTMP_EID_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EFILECTMP_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EFILECTMP_MODIFIED_NN" NOT NULL ENABLE, 
