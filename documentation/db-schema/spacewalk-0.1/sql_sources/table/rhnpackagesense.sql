...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNPACKAGESENSE" 
   (	"ID" NUMBER CONSTRAINT "RHN_PKG_SENSE_ID_NN" NOT NULL ENABLE, 
	"LABEL" VARCHAR2(32) CONSTRAINT "RHN_PKG_SENSE_LABEL_NN" NOT NULL ENABLE, 
