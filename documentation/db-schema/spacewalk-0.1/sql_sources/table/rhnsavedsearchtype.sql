...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNSAVEDSEARCHTYPE" 
   (	"ID" NUMBER CONSTRAINT "RHN_SSTYPE_ID_NN" NOT NULL ENABLE, 
	"LABEL" VARCHAR2(8) CONSTRAINT "RHN_SSTYPE_LABEL_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_SSTYPE_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_SSTYPE_MODIFIED_NN" NOT NULL ENABLE, 
