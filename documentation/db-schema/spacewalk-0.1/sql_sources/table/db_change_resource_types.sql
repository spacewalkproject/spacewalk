...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."DB_CHANGE_RESOURCE_TYPES" 
   (	"RESOURCE_TYPE" VARCHAR2(255) CONSTRAINT "DC_RESOURCETYPE_RT_NN" NOT NULL ENABLE, 
	 CONSTRAINT "DC_RESOURCETYPE_RT_PK" PRIMARY KEY ("RESOURCE_TYPE")
