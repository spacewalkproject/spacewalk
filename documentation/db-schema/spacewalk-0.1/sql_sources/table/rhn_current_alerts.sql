...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHN_CURRENT_ALERTS" 
   (	"RECID" NUMBER(12,0) CONSTRAINT "RHN_ALRTS_RECID_NN" NOT NULL ENABLE, 
	"DATE_SUBMITTED" DATE, 
	...
	"CUSTOMER_ID" NUMBER(12,0) CONSTRAINT "RHN_ALRTS_CUST_ID_NN" NOT NULL ENABLE, 
	"NETSAINT_ID" NUMBER(12,0), 
	"PROBE_TYPE" VARCHAR2(20) DEFAULT 'none', 
	"IN_PROGRESS" CHAR(1) DEFAULT 1 CONSTRAINT "RHN_ALRTS_IN_PROG_NN" NOT NULL ENABLE, 
