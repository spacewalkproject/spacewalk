...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNUSERDEFAULTSYSTEMGROUPS" 
   (	"USER_ID" NUMBER CONSTRAINT "RHN_UDSG_UID_NN" NOT NULL ENABLE, 
	"SYSTEM_GROUP_ID" NUMBER CONSTRAINT "RHN_UDSG_CID_NN" NOT NULL ENABLE, 
