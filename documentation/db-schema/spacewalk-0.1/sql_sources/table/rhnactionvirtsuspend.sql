...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNACTIONVIRTSUSPEND" 
   (	"ACTION_ID" NUMBER CONSTRAINT "RHN_AVSUSPEND_AID_NN" NOT NULL ENABLE, 
	"UUID" VARCHAR2(128) CONSTRAINT "RHN_AVSUSPEND_UUID_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_AVSUSPEND_CREAT_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_AVSUSPEND_MOD_NN" NOT NULL ENABLE, 
