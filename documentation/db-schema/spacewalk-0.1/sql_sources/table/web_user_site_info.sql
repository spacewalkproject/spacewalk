...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."WEB_USER_SITE_INFO" 
   (	"ID" NUMBER CONSTRAINT "WUSI_ID_NN" NOT NULL ENABLE, 
	"WEB_USER_ID" NUMBER, 
	"EMAIL" VARCHAR2(128), 
	"EMAIL_UC" VARCHAR2(128), 
	"ALT_FIRST_NAMES" VARCHAR2(128), 
	"ALT_LAST_NAME" VARCHAR2(128), 
	"ADDRESS1" VARCHAR2(128) CONSTRAINT "WUSI_ADDR1_NN" NOT NULL ENABLE, 
	"ADDRESS2" VARCHAR2(128), 
	"ADDRESS3" VARCHAR2(128), 
	"ADDRESS4" VARCHAR2(128), 
	"CITY" VARCHAR2(128) CONSTRAINT "WUSI_CITY_NN" NOT NULL ENABLE, 
	"STATE" VARCHAR2(64), 
	"ZIP" VARCHAR2(64), 
	"COUNTRY" CHAR(2) CONSTRAINT "WUSI_COUNTRY_NN" NOT NULL ENABLE, 
	"PHONE" VARCHAR2(32), 
	"FAX" VARCHAR2(32), 
	"URL" VARCHAR2(128), 
  ...
  TABLESPACE "DATA_TBS"  ENABLE, 
	 ...
	 CONSTRAINT "WUSI_TYPE_FK" FOREIGN KEY ("TYPE")
	  REFERENCES "RHNSAT"."WEB_USER_SITE_TYPE" ("TYPE") ENABLE
