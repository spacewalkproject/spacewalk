...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHN_CONTACT_METHODS" 
   (	"RECID" NUMBER(12,0) CONSTRAINT "RHN_CMETH_RECID_NN" NOT NULL ENABLE, 
	"METHOD_NAME" VARCHAR2(20), 
	"CONTACT_ID" NUMBER(12,0) CONSTRAINT "RHN_CMETH_CONTACT_ID_NN" NOT NULL ENABLE, 
	"SCHEDULE_ID" NUMBER(12,0), 
	"METHOD_TYPE_ID" NUMBER(12,0) CONSTRAINT "RHN_CMETH_METH_TYPE_NN" NOT NULL ENABLE, 
	...
	"NOTIFICATION_FORMAT_ID" NUMBER(12,0) DEFAULT 4 CONSTRAINT "RHN_CMETH_NOTIF_FMT_NN" NOT NULL ENABLE, 
  ...
  TABLESPACE "DATA_TBS"  ENABLE, 
	 ...
	 CONSTRAINT "RHN_CMETH_METHOD_TYPE_ID_FK" FOREIGN KEY ("METHOD_TYPE_ID")
	  REFERENCES "RHNSAT"."RHN_METHOD_TYPES" ("RECID") ENABLE, 
	 CONSTRAINT "RHN_CMETH_PAGER_TYPE_ID_FK" FOREIGN KEY ("PAGER_TYPE_ID")
	  REFERENCES "RHNSAT"."RHN_PAGER_TYPES" ("RECID") ENABLE, 
	 ...
	 CONSTRAINT "RHN_CMETH_SCHEDULE_ID_FK" FOREIGN KEY ("SCHEDULE_ID")
	  REFERENCES "RHNSAT"."RHN_SCHEDULES" ("RECID") ENABLE, 
