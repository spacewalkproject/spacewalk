...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNERRATAFILEPACKAGE" 
   (	"PACKAGE_ID" NUMBER CONSTRAINT "RHN_EFILEP_PID_NN" NOT NULL ENABLE, 
	"ERRATA_FILE_ID" NUMBER CONSTRAINT "RHN_EFILEP_FILEID_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EFILEP_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EFILEP_MODIFIED_NN" NOT NULL ENABLE, 
