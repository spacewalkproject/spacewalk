...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNERRATAQUEUE" 
   (	"ERRATA_ID" NUMBER CONSTRAINT "RHN_EQUEUE_EID_NN" NOT NULL ENABLE, 
	"NEXT_ACTION" DATE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EQUEUE_CREATED_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_EQUEUE_MODIFIED_NN" NOT NULL ENABLE, 
