...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "RHNSAT"."RHNACTIONVIRTDESTROY" 
   (	"ACTION_ID" NUMBER CONSTRAINT "RHN_AVD_AID_NN" NOT NULL ENABLE, 
	"UUID" VARCHAR2(128) CONSTRAINT "RHN_AVD_UUID_NN" NOT NULL ENABLE, 
	"CREATED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_AVD_CREAT_NN" NOT NULL ENABLE, 
	"MODIFIED" DATE DEFAULT (sysdate) CONSTRAINT "RHN_AVD_MOD_NN" NOT NULL ENABLE, 
