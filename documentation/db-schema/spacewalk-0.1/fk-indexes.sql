--missed index on DB_CHANGE_SCRIPT_PARSED table for DBCSP_DBCSC_BUG_ID_SEQ_NO_FK constraint 
create index fk_no_index_0 on DB_CHANGE_SCRIPT_PARSED (BUG_ID, SEQ_NO);
...
create index fk_no_index_2 on RHNACTIONCONFIGFILENAME (FAILURE_ID);

--missed index on RHNACTIONCONFIGFILENAME table for RHN_ACTIONCF_NAME_CFNID_FK constraint 
create index fk_no_index_3 on RHNACTIONCONFIGFILENAME (CONFIG_FILE_NAME_ID);

--missed index on RHNACTIONCONFIGREVISION table for RHN_ACTIONCR_FAILID_FK constraint 
create index fk_no_index_4 on RHNACTIONCONFIGREVISION (FAILURE_ID);

--missed index on RHNACTIONKICKSTART table for RHN_ACTIONKS_KSTID_FK constraint 
create index fk_no_index_5 on RHNACTIONKICKSTART (KSTREE_ID);

--missed index on RHNACTIONKICKSTARTGUEST table for RHN_ACTIONKS_XENGUEST_KSID_FK constraint 
create index fk_no_index_6 on RHNACTIONKICKSTARTGUEST (KS_SESSION_ID);

--missed index on RHNACTIONKICKSTARTGUEST table for RHN_ACTIONKS_XENGUEST_KSTID_FK constraint 
create index fk_no_index_7 on RHNACTIONKICKSTARTGUEST (KSTREE_ID);
...
create index fk_no_index_17 on RHNBLACKLISTOBSOLETES (EVR_ID);

--missed index on RHNBLACKLISTOBSOLETES table for RHN_BL_OBS_INID_FK constraint 
create index fk_no_index_18 on RHNBLACKLISTOBSOLETES (IGNORE_NAME_ID);

--missed index on RHNBLACKLISTOBSOLETES table for RHN_BL_OBS_PAID_FK constraint 
create index fk_no_index_19 on RHNBLACKLISTOBSOLETES (PACKAGE_ARCH_ID);

--missed index on RHNCHANNEL table for RHN_CHANNEL_CAID_FK constraint 
create index fk_no_index_20 on RHNCHANNEL (CHANNEL_ARCH_ID);
