...
import actions
from client.translate import _
from client import rhnErrors
from client import rhnAuth
from client import rhnLog
from client import rpcServer
...
def run_action(method, params):
    try:
        ...
        (status, message, data) = actions.do_call(method, params)   
