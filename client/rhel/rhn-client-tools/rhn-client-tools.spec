...
%changelog
* Thu Jan 10 2019 Michael Mraka <michael.mraka@redhat.com> 2.9.36-1
- Revert "1627438 - don't build python2 packages on new Fedoras"

* Wed Dec 19 2018 Michael Mraka <michael.mraka@redhat.com> 2.9.35-1
- xml.dom is not in python2-libs on opensuse
- still needs python2 for rhn_register gui in build

* Wed Dec 19 2018 Michael Mraka <michael.mraka@redhat.com> 2.9.34-1
