...
def initiate(kickstart_host, profile_name, base, extra_append, static_device="", preserve_files=[]):
    log = up2dateLog.initLog() 
    log.log_me("initiating spacewalkkoan kickstart")
    return spacewalkkoan.initiate(kickstart_host, profile_name, base, extra_append=extra_append,
