...
PACKAGE_LIST="spacewalk-pylint spacewalk-python2-pylint spacewalk-python3-pylint rhnlib rhn-client-tools rhnsd yum-rhn-plugin spacewalk-koan perl-Satcon spacewalk-proxy-html spacewalk-proxy-docs spacecmd rhn-custom-info spacewalk-config python-gzipstream"
