...
install BDB.pm         $RPM_BUILD_ROOT$perl_lib
install BDB2.pm        $RPM_BUILD_ROOT$perl_lib

mkdir -p $RPM_BUILD_ROOT%apache_home
install test_bdb.pl    $RPM_BUILD_ROOT%apache_home
...
%changelog
* Thu Jun  5 2008 Milan Zazrivec <mzazrivec@redhat.com> 2.9.3-8
- rebuilt in dist.cvs
