...
cp Bootstrap.pm $RPM_BUILD_ROOT$nplib/SatConfig
cp TranslateKey.pm $RPM_BUILD_ROOT$nplib/SatConfig
cp TestBootstrap.pm $RPM_BUILD_ROOT$nplib/SatConfig/test
cp Apache.SatConfig-bootstrap-server $RPM_BUILD_ROOT%registry
