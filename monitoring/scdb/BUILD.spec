...
echo "%attr(444,apache,apache) $installsitelib/NOCpulse/SCDB.pm" >> %{name}-%{version}-%{release}-filelist

%files -f %{name}-%{version}-%{release}-filelist
%attr(755,apache,apache) %dir %bdbdir
/etc/rc.d/np.d/apachereg/Apache.scdb
