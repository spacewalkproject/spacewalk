...
install MonitoringAccessHandler.pm $RPM_BUILD_ROOT$np_lib
install EventHandler.pm $RPM_BUILD_ROOT$np_lib
install HttpsMX.pm $RPM_BUILD_ROOT$np_lib
install ApacheSSL.eventReceivers $RPM_BUILD_ROOT%registry
install ApacheSSL.eventReceivers-proxies $RPM_BUILD_ROOT%registry
