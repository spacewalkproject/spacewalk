...
BuildRequires: perl(NOCpulse::Debug) perl(NOCpulse::Config) perl(DBD::Oracle) perl(DBD::Object) perl(DBI)
...
%changelog
* Tue Oct 21 2008 Miroslav Suchý <msuchy@redhat.com> 1.28.6-1
