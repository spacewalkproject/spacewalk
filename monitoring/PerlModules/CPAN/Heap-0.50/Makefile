...
manifypods : pure_all Heap.pm
	@$(POD2MAN) \
	Heap.pm \
	$(INST_MAN3DIR)/Heap.$(MAN3EXT)
...
clean ::
	-cd Binary && $(TEST_F) Makefile && $(MAKE) clean
...
realclean purge ::  clean
	-cd Binary && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Binary && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Binomial && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Binomial && $(TEST_F) Makefile && $(MAKE)  realclean
	-cd Elem && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd Elem && $(TEST_F) Makefile && $(MAKE)  realclean
...
$(MAKE_APERL_FILE) : $(FIRST_MAKEFILE)
	...
	@$(PERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) \
		Makefile.PL DIR=Binary:Binomial:Elem:Fibonacci \
...
test :: $(TEST_TYPE)
	@cd Binary && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Binomial && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Elem && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
	@cd Fibonacci && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
