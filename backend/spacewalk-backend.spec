...
# $Id$
%changelog
* Mon Aug 30 2010 Justin Sherrill <jsherril@redhat.com> 1.1.51-1
- adding missing commit to make repo generation after reposync work again
  (jsherril@redhat.com)

* Thu Aug 19 2010 Milan Zazrivec <mzazrivec@redhat.com> 1.1.50-1
- 624732 - restore config files management functionality
