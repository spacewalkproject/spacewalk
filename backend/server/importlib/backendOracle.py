...
class OracleBackend(Backend):
    tables = TableCollection(
        ...
        Table('rhnErrata',
            fields      = {
                'id'            : DBint(),
                'advisory'      : DBstring(4001),
                'advisory_name' : DBstring(4001),
                'advisory_rel'  : DBint(),
                'advisory_type' : DBstring(4001),
                'product'       : DBstring(4001),
                'description'   : DBstring(4001),
                'synopsis'      : DBstring(4001),
                'topic'         : DBstring(4001),
                'solution'      : DBstring(4001),
                'topic'         : DBstring(4001),
                'notes'         : DBstring(4001),
                'refers_to'     : DBstring(4001),
                'org_id'        : DBint(),
                'severity_id'   : DBint(),
        ...
        Table('rhnChannel',
            fields      = {
                ...
                'label'         : DBstring(129),
                'basedir'       : DBstring(257),
                'name'          : DBstring(65),
                'summary'       : DBstring(501),
                'description'   : DBstring(4001),
                'last_modified' : DBdateTime(),
                'gpg_key_url'   : DBstring(257),
                'product_name_id' : DBint(),
                'receiving_updates' : DBstring(4),
            },
            pk          = ['label'],
        ),
