...
class UI:
    def __init__(self):
	    ...
	    option(         "--start-date",             action="store",
	        help="The start date limit that the last modified dates are compared against. Must be in the format 'YYYYMMDDHH24MISS'."),
	    option(         "--end-date",                action="store",
	        help="The end date limit that the last modified dates are compared against. Must be in the format 'YYYYMMDDHH24MISS'."),
